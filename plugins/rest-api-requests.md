---
url: https://developer.wordpress.org/plugins/rest-api/requests
scraped_at: 2025-10-20T03:15:44.294Z
---

[Skip to content](https://developer.wordpress.org/plugins/rest-api/requests/#wp--skip-link--target)
...
[Home](https://developer.wordpress.org/)[Plugin Handbook](https://developer.wordpress.org/plugins/)[REST API](https://developer.wordpress.org/plugins/rest-api/)Requests
...
- [Overview](https://developer.wordpress.org/plugins/rest-api/requests/#overview)
- [WP\_REST\_Request](https://developer.wordpress.org/plugins/rest-api/requests/#wp_rest_request)
- [Request Properties](https://developer.wordpress.org/plugins/rest-api/requests/#request-properties)
  - [Method](https://developer.wordpress.org/plugins/rest-api/requests/#method)
  - [Route](https://developer.wordpress.org/plugins/rest-api/requests/#route)
  - [Headers](https://developer.wordpress.org/plugins/rest-api/requests/#headers)
  - [Parameters](https://developer.wordpress.org/plugins/rest-api/requests/#parameters)
  - [Attributes](https://developer.wordpress.org/plugins/rest-api/requests/#attributes)
- [Internal Requests](https://developer.wordpress.org/plugins/rest-api/requests/#internal-requests)

[↑ Back to top](https://developer.wordpress.org/plugins/rest-api/requests/#wp--skip-link--target)
...
``
[Copy](https://developer.wordpress.org/plugins/rest-api/requests/#)
...
#### [URL Params](https://developer.wordpress.org/plugins/rest-api/requests/\#url-params)
...
``
[Expand code](https://developer.wordpress.org/plugins/rest-api/requests/#)
...
#### [Query Params](https://developer.wordpress.org/plugins/rest-api/requests/\#query-params)
...
#### [Body Params](https://developer.wordpress.org/plugins/rest-api/requests/\#body-params)
...
#### [File Params](https://developer.wordpress.org/plugins/rest-api/requests/\#file-params)
...
[PreviousRoutes & EndpointsPrevious: Routes & Endpoints](https://developer.wordpress.org/plugins/rest-api/routes-endpoints/)

[NextResponsesNext: Responses](https://developer.wordpress.org/plugins/rest-api/responses-2/)
