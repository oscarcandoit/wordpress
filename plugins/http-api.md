---
url: https://developer.wordpress.org/plugins/http-api
scraped_at: 2025-10-20T03:13:55.767Z
---

[Skip to content](https://developer.wordpress.org/plugins/http-api/#wp--skip-link--target)
...
[Home](https://developer.wordpress.org/)[Plugin Handbook](https://developer.wordpress.org/plugins/)HTTP API
...
- [Introduction](https://developer.wordpress.org/plugins/http-api/#introduction)
  - [HTTP methods](https://developer.wordpress.org/plugins/http-api/#http-methods)
  - [Response codes](https://developer.wordpress.org/plugins/http-api/#response-codes)
- [GETting data from an API](https://developer.wordpress.org/plugins/http-api/#getting-data-from-an-api)
  - [GET the body you always wanted](https://developer.wordpress.org/plugins/http-api/#get-the-body-you-always-wanted)
  - [GET the response code](https://developer.wordpress.org/plugins/http-api/#get-the-response-code)
  - [GET a specific header](https://developer.wordpress.org/plugins/http-api/#get-a-specific-header)
  - [GET using basic authentication](https://developer.wordpress.org/plugins/http-api/#get-using-basic-authentication)
- [POSTing data to an API](https://developer.wordpress.org/plugins/http-api/#posting-data-to-an-api)
- [HEADing off bandwidth usage](https://developer.wordpress.org/plugins/http-api/#heading-off-bandwidth-usage)
- [Make any sort of request](https://developer.wordpress.org/plugins/http-api/#make-any-sort-of-request)
- [Introduction to caching](https://developer.wordpress.org/plugins/http-api/#introduction-to-caching)
- [When should you cache?](https://developer.wordpress.org/plugins/http-api/#when-should-you-cache)
- [WordPress Transients](https://developer.wordpress.org/plugins/http-api/#wordpress-transients)
  - [Cache an object ( Set a transient )](https://developer.wordpress.org/plugins/http-api/#cache-an-object-set-a-transient)
  - [Get a cached object ( Get a transient )](https://developer.wordpress.org/plugins/http-api/#get-a-cached-object-get-a-transient)
- [Delete a cached object (Delete a transient)](https://developer.wordpress.org/plugins/http-api/#delete-a-cached-object-delete-a-transient)

[↑ Back to top](https://developer.wordpress.org/plugins/http-api/#wp--skip-link--target)
...
#### [GET](https://developer.wordpress.org/plugins/http-api/\#get)
...
#### [POST](https://developer.wordpress.org/plugins/http-api/\#post)
...
#### [HEAD](https://developer.wordpress.org/plugins/http-api/\#head)
...
#### [Custom Methods](https://developer.wordpress.org/plugins/http-api/\#custom-methods)
...
#### [Code Classes](https://developer.wordpress.org/plugins/http-api/\#code-classes)
...
``
[Copy](https://developer.wordpress.org/plugins/http-api/#)
...
``
[Expand code](https://developer.wordpress.org/plugins/http-api/#)
...
The same helper methods ( `[wp\_remote\_retrieve\_body()](https://developer.wordpress.org/reference/functions/wp_remote_retrieve_body)`, etc ) are available for all of the HTTP method calls, and utilized in the same fashion.

POSTing data is done using the `[wp\_remote\_post()](https://developer.wordpress.org/reference/functions/wp_remote_post)` function, and takes exactly the same parameters as `[wp\_remote\_get()](https://developer.wordpress.org/reference/functions/wp_remote_get)`. It should be noted here that you are required to pass in ALL of the elements in the array for the second parameter. The Codex provides the default acceptable values. You only need to care right now about the data you are sending so the other values will be defaulted.
...
Now we need to set up the rest of the values that will be passed to the second parameter of `[wp\_remote\_post()](https://developer.wordpress.org/reference/functions/wp_remote_post)`
...
Caching an object is done with the `[set\_transient()](https://developer.wordpress.org/reference/functions/set_transient)` function. This function takes the following three parameters:
