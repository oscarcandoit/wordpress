---
url: https://developer.wordpress.org/plugins/rest-api/routes-endpoints
scraped_at: 2025-10-20T03:15:57.481Z
---

[Skip to content](https://developer.wordpress.org/plugins/rest-api/routes-endpoints/#wp--skip-link--target)
...
[Home](https://developer.wordpress.org/)[Plugin Handbook](https://developer.wordpress.org/plugins/)[REST API](https://developer.wordpress.org/plugins/rest-api/)Routes & Endpoints
...
- [Overview](https://developer.wordpress.org/plugins/rest-api/routes-endpoints/#overview)
- [Routes](https://developer.wordpress.org/plugins/rest-api/routes-endpoints/#routes)
  - [Namespaces](https://developer.wordpress.org/plugins/rest-api/routes-endpoints/#namespaces)
  - [Resource Paths](https://developer.wordpress.org/plugins/rest-api/routes-endpoints/#resource-paths)
  - [Path Variables](https://developer.wordpress.org/plugins/rest-api/routes-endpoints/#path-variables)
- [Endpoints](https://developer.wordpress.org/plugins/rest-api/routes-endpoints/#endpoints)
  - [HTTP Methods](https://developer.wordpress.org/plugins/rest-api/routes-endpoints/#http-methods)
  - [Callbacks](https://developer.wordpress.org/plugins/rest-api/routes-endpoints/#callbacks)
  - [Arguments](https://developer.wordpress.org/plugins/rest-api/routes-endpoints/#arguments)
- [Summary](https://developer.wordpress.org/plugins/rest-api/routes-endpoints/#summary)

[↑ Back to top](https://developer.wordpress.org/plugins/rest-api/routes-endpoints/#wp--skip-link--target)
...
``
[Expand code](https://developer.wordpress.org/plugins/rest-api/routes-endpoints/#)

[Copy](https://developer.wordpress.org/plugins/rest-api/routes-endpoints/#)
...
#### [Endpoint Callback](https://developer.wordpress.org/plugins/rest-api/routes-endpoints/\#endpoint-callback)
...
#### [Permissions Callback](https://developer.wordpress.org/plugins/rest-api/routes-endpoints/\#permissions-callback)
...
#### [Validation](https://developer.wordpress.org/plugins/rest-api/routes-endpoints/\#validation)
...
#### [Sanitizing](https://developer.wordpress.org/plugins/rest-api/routes-endpoints/\#sanitizing)
...
[PreviousREST API OverviewPrevious: REST API Overview](https://developer.wordpress.org/plugins/rest-api/rest-api-overview/)

[NextRequestsNext: Requests](https://developer.wordpress.org/plugins/rest-api/requests/)
