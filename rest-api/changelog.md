...
scraped_at: 2025-10-20T02:02:18.265Z
---

[Skip to content](https://developer.wordpress.org/rest-api/changelog/#wp--skip-link--target)
...
[Home](https://developer.wordpress.org/)[REST API Handbook](https://developer.wordpress.org/rest-api/)Changelog
...
[↑ Back to top](https://developer.wordpress.org/rest-api/changelog/#wp--skip-link--target)
...
[Improve it on GitHub: Changelog](https://github.com/WP-API/docs/edit/master/changelog.md)

Changelog

[See list of changes: Changelog](https://github.com/WP-API/docs/commits/master/changelog.md)

[PreviousGlossaryPrevious: Glossary](https://developer.wordpress.org/rest-api/glossary/)
