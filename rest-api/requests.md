---
url: https://developer.wordpress.org/rest-api/requests
scraped_at: 2025-10-20T02:02:25.119Z
---

[Skip to content](https://developer.wordpress.org/rest-api/requests/#wp--skip-link--target)
...
[Home](https://developer.wordpress.org/)[REST API Handbook](https://developer.wordpress.org/rest-api/)Requests
...
- [WP\_REST\_Request](https://developer.wordpress.org/rest-api/requests/#wp_rest_request)
...
[↑ Back to top](https://developer.wordpress.org/rest-api/requests/#wp--skip-link--target)
...
#### [URL Params](https://developer.wordpress.org/rest-api/requests/\#url-params)
...
#### [Query Params](https://developer.wordpress.org/rest-api/requests/\#query-params)
...
#### [Body Params](https://developer.wordpress.org/rest-api/requests/\#body-params)
...
#### [File Params](https://developer.wordpress.org/rest-api/requests/\#file-params)
...
[Improve it on GitHub: Requests](https://github.com/WP-API/docs/edit/master/requests.md)

Changelog

[See list of changes: Requests](https://github.com/WP-API/docs/commits/master/requests.md)

[PreviousWp Site Health TestsPrevious: Wp Site Health Tests](https://developer.wordpress.org/rest-api/reference/wp-site-health-tests/)

[NextGlossaryNext: Glossary](https://developer.wordpress.org/rest-api/glossary/)
