...
scraped_at: 2025-10-20T02:01:35.909Z
---

[Skip to content](https://developer.wordpress.org/rest-api/extending-the-rest-api/adding-custom-endpoints/#wp--skip-link--target)
...
[Home](https://developer.wordpress.org/)[REST API Handbook](https://developer.wordpress.org/rest-api/)[Extending the REST API](https://developer.wordpress.org/rest-api/extending-the-rest-api/)Adding Custom Endpoints
...
- [Bare Basics](https://developer.wordpress.org/rest-api/extending-the-rest-api/adding-custom-endpoints/#bare-basics)
  - [Namespacing](https://developer.wordpress.org/rest-api/extending-the-rest-api/adding-custom-endpoints/#namespacing)
  - [Arguments](https://developer.wordpress.org/rest-api/extending-the-rest-api/adding-custom-endpoints/#arguments)
  - [Return Value](https://developer.wordpress.org/rest-api/extending-the-rest-api/adding-custom-endpoints/#return-value)
  - [Permissions Callback](https://developer.wordpress.org/rest-api/extending-the-rest-api/adding-custom-endpoints/#permissions-callback)
  - [Discovery](https://developer.wordpress.org/rest-api/extending-the-rest-api/adding-custom-endpoints/#discovery)
- [The Controller Pattern](https://developer.wordpress.org/rest-api/extending-the-rest-api/adding-custom-endpoints/#the-controller-pattern)
- [Examples](https://developer.wordpress.org/rest-api/extending-the-rest-api/adding-custom-endpoints/#examples)

[↑ Back to top](https://developer.wordpress.org/rest-api/extending-the-rest-api/adding-custom-endpoints/#wp--skip-link--target)
...
[Improve it on GitHub: Adding Custom Endpoints](https://github.com/WP-API/docs/edit/master/extending-the-rest-api/adding-custom-endpoints.md)

Changelog

[See list of changes: Adding Custom Endpoints](https://github.com/WP-API/docs/commits/master/extending-the-rest-api/adding-custom-endpoints.md)

[PreviousExtending the REST APIPrevious: Extending the REST API](https://developer.wordpress.org/rest-api/extending-the-rest-api/)

[NextAdding REST API Support For Custom Content TypesNext: Adding REST API Support For Custom Content Types](https://developer.wordpress.org/rest-api/extending-the-rest-api/adding-rest-api-support-for-custom-content-types/)
