---
url: https://developer.wordpress.org/reference/classes/wp_site_health
scraped_at: 2025-10-20T03:13:47.737Z
---

[Skip to content](https://developer.wordpress.org/reference/classes/wp_site_health/#wp--skip-link--target)
...
[Home](https://developer.wordpress.org/)[Reference](https://developer.wordpress.org/reference/)[Classes](https://developer.wordpress.org/reference/classes/)WP\_Site\_Health

Search

# class WP\_Site\_Health {}

## In this article

Table of Contents

- [Methods](https://developer.wordpress.org/reference/classes/wp_site_health/#methods)
- [Source](https://developer.wordpress.org/reference/classes/wp_site_health/#source)
- [Changelog](https://developer.wordpress.org/reference/classes/wp_site_health/#changelog)

[↑ Back to top](https://developer.wordpress.org/reference/classes/wp_site_health/#wp--skip-link--target)
...
| Name | Description |
| --- | --- |
| [WP\_Site\_Health::\_\_construct](https://developer.wordpress.org/reference/classes/wp_site_health/__construct/) | [WP\_Site\_Health](https://developer.wordpress.org/reference/classes/wp_site_health/) constructor. |
| [WP\_Site\_Health::admin\_body\_class](https://developer.wordpress.org/reference/classes/wp_site_health/admin_body_class/) | Adds a class to the body HTML tag. |
| [WP\_Site\_Health::available\_object\_cache\_services](https://developer.wordpress.org/reference/classes/wp_site_health/available_object_cache_services/) | Returns a list of available persistent object cache services. |
| [WP\_Site\_Health::can\_perform\_loopback](https://developer.wordpress.org/reference/classes/wp_site_health/can_perform_loopback/) | Runs a loopback test on the site. |
| [WP\_Site\_Health::check\_for\_page\_caching](https://developer.wordpress.org/reference/classes/wp_site_health/check_for_page_caching/) | Checks if site has page cache enabled or not. |
| [WP\_Site\_Health::check\_wp\_version\_check\_exists](https://developer.wordpress.org/reference/classes/wp_site_health/check_wp_version_check_exists/) | Tests whether \`wp\_version\_check\` is blocked. |
| [WP\_Site\_Health::detect\_plugin\_theme\_auto\_update\_issues](https://developer.wordpress.org/reference/classes/wp_site_health/detect_plugin_theme_auto_update_issues/) | Checks for potential issues with plugin and theme auto-updates. |
| [WP\_Site\_Health::enqueue\_scripts](https://developer.wordpress.org/reference/classes/wp_site_health/enqueue_scripts/) | Enqueues the site health scripts. |
| [WP\_Site\_Health::get\_autoloaded\_options\_size](https://developer.wordpress.org/reference/classes/wp_site_health/get_autoloaded_options_size/) | Calculates total amount of autoloaded data. |
| [WP\_Site\_Health::get\_cron\_tasks](https://developer.wordpress.org/reference/classes/wp_site_health/get_cron_tasks/) | Populates the list of cron events and store them to a class-wide variable. |
| [WP\_Site\_Health::get\_good\_response\_time\_threshold](https://developer.wordpress.org/reference/classes/wp_site_health/get_good_response_time_threshold/) | Gets the threshold below which a response time is considered good. |
| [WP\_Site\_Health::get\_instance](https://developer.wordpress.org/reference/classes/wp_site_health/get_instance/) | Returns an instance of the [WP\_Site\_Health](https://developer.wordpress.org/reference/classes/wp_site_health/) class, or create one if none exist yet. |
| [WP\_Site\_Health::get\_page\_cache\_detail](https://developer.wordpress.org/reference/classes/wp_site_health/get_page_cache_detail/) | Gets page cache details. |
| [WP\_Site\_Health::get\_page\_cache\_headers](https://developer.wordpress.org/reference/classes/wp_site_health/get_page_cache_headers/) | Returns a list of headers and its verification callback to verify if page cache is enabled or not. |
| [WP\_Site\_Health::get\_test\_authorization\_header](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_authorization_header/) | Tests if the Authorization header has the expected values. |
| [WP\_Site\_Health::get\_test\_autoloaded\_options](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_autoloaded_options/) | Tests the number of autoloaded options. |
| [WP\_Site\_Health::get\_test\_available\_updates\_disk\_space](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_available_updates_disk_space/) | Tests available disk space for updates. |
| [WP\_Site\_Health::get\_test\_background\_updates](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_background_updates/) | Tests if WordPress can run automated background updates. |
| [WP\_Site\_Health::get\_test\_dotorg\_communication](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_dotorg_communication/) | Tests if the site can communicate with WordPress.org. |
| [WP\_Site\_Health::get\_test\_file\_uploads](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_file_uploads/) | Tests if ‘file\_uploads’ directive in PHP.ini is turned off. |
| [WP\_Site\_Health::get\_test\_http\_requests](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_http_requests/) | Tests if HTTP requests are blocked. |
| [WP\_Site\_Health::get\_test\_https\_status](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_https_status/) | Tests if the site is serving content over HTTPS. |
| [WP\_Site\_Health::get\_test\_is\_in\_debug\_mode](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_is_in_debug_mode/) | Tests if debug information is enabled. |
| [WP\_Site\_Health::get\_test\_loopback\_requests](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_loopback_requests/) | Tests if loopbacks work as expected. |
| [WP\_Site\_Health::get\_test\_page\_cache](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_page_cache/) | Tests if a full page cache is available. |
| [WP\_Site\_Health::get\_test\_persistent\_object\_cache](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_persistent_object_cache/) | Tests if the site uses persistent object cache and recommends to use it if not. |
| [WP\_Site\_Health::get\_test\_php\_default\_timezone](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_php_default_timezone/) | Tests if the PHP default timezone is set to UTC. |
| [WP\_Site\_Health::get\_test\_php\_extensions](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_php_extensions/) | Tests if required PHP modules are installed on the host. |
| [WP\_Site\_Health::get\_test\_php\_sessions](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_php_sessions/) | Tests if there’s an active PHP session that can affect loopback requests. |
| [WP\_Site\_Health::get\_test\_php\_version](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_php_version/) | Tests if the supplied PHP version is supported. |
| [WP\_Site\_Health::get\_test\_plugin\_theme\_auto\_updates](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_plugin_theme_auto_updates/) | Tests if plugin and theme auto-updates appear to be configured correctly. |
| [WP\_Site\_Health::get\_test\_plugin\_version](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_plugin_version/) | Tests if plugins are outdated, or unnecessary. |
| [WP\_Site\_Health::get\_test\_rest\_availability](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_rest_availability/) | Tests if the REST API is accessible. |
| [WP\_Site\_Health::get\_test\_scheduled\_events](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_scheduled_events/) | Tests if scheduled events run as intended. |
| [WP\_Site\_Health::get\_test\_sql\_server](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_sql_server/) | Tests if the SQL server is up to date. |
| [WP\_Site\_Health::get\_test\_ssl\_support](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_ssl_support/) | Checks if the HTTP API can handle SSL/TLS requests. |
| [WP\_Site\_Health::get\_test\_theme\_version](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_theme_version/) | Tests if themes are outdated, or unnecessary. |
| [WP\_Site\_Health::get\_test\_update\_temp\_backup\_writable](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_update_temp_backup_writable/) | Tests if plugin and theme temporary backup directories are writable or can be created. |
| [WP\_Site\_Health::get\_test\_utf8mb4\_support](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_utf8mb4_support/) | Tests if the database server is capable of using utf8mb4. |
| [WP\_Site\_Health::get\_test\_wordpress\_version](https://developer.wordpress.org/reference/classes/wp_site_health/get_test_wordpress_version/) | Tests for WordPress version and outputs it. |
| [WP\_Site\_Health::get\_tests](https://developer.wordpress.org/reference/classes/wp_site_health/get_tests/) | Returns a set of tests that belong to the site status page. |
| [WP\_Site\_Health::has\_late\_cron](https://developer.wordpress.org/reference/classes/wp_site_health/has_late_cron/) | Checks if any scheduled tasks are late. |
| [WP\_Site\_Health::has\_missed\_cron](https://developer.wordpress.org/reference/classes/wp_site_health/has_missed_cron/) | Checks if any scheduled tasks have been missed. |
| [WP\_Site\_Health::is\_development\_environment](https://developer.wordpress.org/reference/classes/wp_site_health/is_development_environment/) | Checks if the current environment type is set to ‘development’ or ‘local’. |
| [WP\_Site\_Health::maybe\_create\_scheduled\_event](https://developer.wordpress.org/reference/classes/wp_site_health/maybe_create_scheduled_event/) | Creates a weekly cron event, if one does not already exist. |
| [WP\_Site\_Health::perform\_test](https://developer.wordpress.org/reference/classes/wp_site_health/perform_test/) | Runs a Site Health test directly. |
| [WP\_Site\_Health::prepare\_sql\_data](https://developer.wordpress.org/reference/classes/wp_site_health/prepare_sql_data/) | Runs the SQL version checks. |
| [WP\_Site\_Health::should\_suggest\_persistent\_object\_cache](https://developer.wordpress.org/reference/classes/wp_site_health/should_suggest_persistent_object_cache/) | Determines whether to suggest using a persistent object cache. |
| [WP\_Site\_Health::show\_site\_health\_tab](https://developer.wordpress.org/reference/classes/wp_site_health/show_site_health_tab/) | Outputs the content of a tab in the Site Health screen. |
| [WP\_Site\_Health::test\_php\_extension\_availability](https://developer.wordpress.org/reference/classes/wp_site_health/test_php_extension_availability/) | Checks if the passed extension or function are available. |
| [WP\_Site\_Health::wp\_cron\_scheduled\_check](https://developer.wordpress.org/reference/classes/wp_site_health/wp_cron_scheduled_check/) | Runs the scheduled event to check and update the latest site health status for the website. |
| [WP\_Site\_Health::wp\_schedule\_test\_init](https://developer.wordpress.org/reference/classes/wp_site_health/wp_schedule_test_init/) | Initiates the WP\_Cron schedule test cases. |

## [Source](https://developer.wordpress.org/reference/classes/wp_site_health/\#source)

`wp-admin/includes/class-wp-site-health.php`
[Expand code](https://developer.wordpress.org/reference/classes/wp_site_health/#)

[Copy](https://developer.wordpress.org/reference/classes/wp_site_health/#)
...
class WP_Site_Health {
	 ...
	 *
	 * @since 5.2.0
	 * @since 5.7.0 Updated to rely on wp_is_using_https() and wp_is_https_supported().
	 *
	 * @return array The test results.
	 */
...
[View all references](https://developer.wordpress.org/reference/files/wp-admin/includes/class-wp-site-health.php/) [View on Trac](https://core.trac.wordpress.org/browser/tags/6.8.3/src/wp-admin/includes/class-wp-site-health.php#L11) [View on GitHub](https://github.com/WordPress/wordpress-develop/blob/6.8.3/src/wp-admin/includes/class-wp-site-health.php#L11-L3626)
...
You must [log in](https://login.wordpress.org/?redirect_to=https%3A%2F%2Fdeveloper.wordpress.org%2Freference%2Fclasses%2Fwp_site_health%2F) before being able to contribute a note or feedback.
