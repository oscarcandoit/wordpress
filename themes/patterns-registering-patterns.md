...
#### [Conditionally registering patterns via register\_block\_pattern()](https://developer.wordpress.org/themes/patterns/registering-patterns/\#conditionally-registering-patterns-via-register_block_pattern)
