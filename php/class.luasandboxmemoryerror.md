---
url: https://www.php.net/manual/en/class.luasandboxmemoryerror.php
scraped_at: 2025-10-20T02:42:26.564Z
---

Change language:EnglishGermanSpanishFrenchItalianJapaneseBrazilian PortugueseRussianTurkishUkrainianChinese (Simplified)Other

# The LuaSandboxMemoryError class [¶](https://www.php.net/manual/en/class.luasandboxmemoryerror.php\#class.luasandboxmemoryerror)

(PECL luasandbox >= 1.0.0)

## Introduction [¶](https://www.php.net/manual/en/class.luasandboxmemoryerror.php\#luasandboxmemoryerror.intro)

Exception thrown when Lua cannot allocate memory.


## Class synopsis [¶](https://www.php.net/manual/en/class.luasandboxmemoryerror.php\#luasandboxmemoryerror.synopsis)

class **LuaSandboxMemoryError**extends [LuaSandboxFatalError](https://www.php.net/manual/en/class.luasandboxfatalerror.php)
{
...
## See Also [¶](https://www.php.net/manual/en/class.luasandboxmemoryerror.php\#luasandboxmemoryerror.seealso)

- [LuaSandbox::setMemoryLimit()](https://www.php.net/manual/en/luasandbox.setmemorylimit.php)

### Found A Problem?

[Learn How To Improve This Page](https://github.com/php/doc-base/blob/master/README.md "This will take you to our contribution guidelines on GitHub")
•
[Submit a Pull Request](https://github.com/php/doc-en/blob/master/reference/luasandbox/luasandboxmemoryerror.xml)
•
[Report a Bug](https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.luasandboxmemoryerror%0A%0A---)

[＋add a note](https://www.php.net/manual/add-note.php?sect=class.luasandboxmemoryerror&repo=en&redirect=https://www.php.net/manual/en/class.luasandboxmemoryerror.php)
