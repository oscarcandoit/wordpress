---
url: https://www.php.net/manual/en/class.luasandboxruntimeerror.php
scraped_at: 2025-10-20T02:37:01.426Z
---

Change language:EnglishGermanSpanishFrenchItalianJapaneseBrazilian PortugueseRussianTurkishUkrainianChinese (Simplified)Other

# The LuaSandboxRuntimeError class [¶](https://www.php.net/manual/en/class.luasandboxruntimeerror.php\#class.luasandboxruntimeerror)

(PECL luasandbox >= 1.0.0)

## Introduction [¶](https://www.php.net/manual/en/class.luasandboxruntimeerror.php\#luasandboxruntimeerror.intro)
...
## Class synopsis [¶](https://www.php.net/manual/en/class.luasandboxruntimeerror.php\#luasandboxruntimeerror.synopsis)

class **LuaSandboxRuntimeError**extends [LuaSandboxError](https://www.php.net/manual/en/class.luasandboxerror.php)
{
...
•
[Submit a Pull Request](https://github.com/php/doc-en/blob/master/reference/luasandbox/luasandboxruntimeerror.xml)
•
[Report a Bug](https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.luasandboxruntimeerror%0A%0A---)

[＋add a note](https://www.php.net/manual/add-note.php?sect=class.luasandboxruntimeerror&repo=en&redirect=https://www.php.net/manual/en/class.luasandboxruntimeerror.php)
