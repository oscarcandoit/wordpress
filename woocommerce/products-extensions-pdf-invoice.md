---
url: https://woocommerce.com/documentation/products/extensions/pdf-invoice
scraped_at: 2025-10-20T02:35:38.516Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/pdf-invoice/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/pdf-invoice/#page)
...
PDF Invoices attaches a fully customizable PDF invoice to a paid or completed order and other WooCommerce emails. Invoices can accessed via a Download Invoice link on the Thank You page or in the My Orders area and be resent by selecting Completed Order from the order actions meta box. The layout of templates is fully \[…\]

- [**Hooks and Filters in WooCommerce PDF Invoice**](https://woocommerce.com/document/pdf-invoice-developer-tools/)
Default placeholders from PDF Invoices template This file contains hidden or bidirectional Unicode text that may be interpreted or compiled differently than what appears below. To review, open the file in an editor that reveals hidden Unicode characters. Learn more about bidirectional Unicode characters Show hidden characters HEADER : \[\[PDFFONTFAMILY\]\] : Quickly modify the font \[…\]
