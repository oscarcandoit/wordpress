---
url: https://woocommerce.com/documentation/documentacao-em-portugues/5-entrega/opcoes-de-entrega-basicas
scraped_at: 2025-10-20T02:33:51.793Z
---

[Skip to navigation](https://woocommerce.com/documentation/documentacao-em-portugues/5-entrega/opcoes-de-entrega-basicas/#main-navigation) [Skip to content](https://woocommerce.com/documentation/documentacao-em-portugues/5-entrega/opcoes-de-entrega-basicas/#page)
...
# Opções de Entrega Básicas

* * *

## Documents

- [**Entrega com Taxa Fixa**](https://woocommerce.com/document/entrega-com-taxa-fixa/)
A entrega com Taxa fixa é um método de entrega que pode ser adicionado nas Áreas de entrega. Consulte nosso guia Como configurar as áreas de entrega e criar áreas para serem usadas. A entrega com taxa fixa é um método de entrega no WooCommerce que permite definir uma taxa padrão por item, por classe \[…\]

- [**Entrega para Retirar no local**](https://woocommerce.com/document/retirar-no-local/)
Entrega para Retirar no local é um método de entrega que pode ser adicionado nas Áreas de entrega. Consulte nosso guia Como configurar as áreas de entrega e criar áreas para serem usadas. A entrega para Retirar no local é um método que permite que os clientes retirem o pedido por conta própria. Instalação e \[…\]

- [**Frete Grátis**](https://woocommerce.com/document/frete-gratis/)
O frete grátis é uma ótima maneira de incentivar os clientes a gastarem mais. Por exemplo, ofereça frete grátis para pedidos acima de R$100. Consulte o nosso Guia de áreas de entrega e crie áreas para começar a usar. Ajuste e configuração Para oferecer o método de frete grátis, ele deve ser adicionado para uma \[…\]

- [**Oferecer Seguro de Entrega**](https://woocommerce.com/document/oferecer-seguro-de-entrega/)
Não existe nenhuma maneira de oferecer seguro, para os produtos que você está enviando, instalada no WooCommerce e em nas opções de entrega. Incluir no preço do produto Uma opção é incluir o custo do seguro no preço de seus produtos. No entanto, a desvantagem é que os clientes poderão ter uma impressão errada sobre \[…\]
