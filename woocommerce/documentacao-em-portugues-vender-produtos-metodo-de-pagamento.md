---
url: https://woocommerce.com/documentation/documentacao-em-portugues/vender-produtos/metodo-de-pagamento
scraped_at: 2025-10-20T02:33:20.867Z
---

[Skip to navigation](https://woocommerce.com/documentation/documentacao-em-portugues/vender-produtos/metodo-de-pagamento/#main-navigation) [Skip to content](https://woocommerce.com/documentation/documentacao-em-portugues/vender-produtos/metodo-de-pagamento/#page)
...
- ## Stripe (Português)
  ...
  - [See all topics](https://woocommerce.com/documentation/documentacao-em-portugues/vender-produtos/metodo-de-pagamento/stripe-portugues/)
...
O WooCommerce PayPal Checkout (disponível somente em inglês) permite que sua loja aceite pagamentos via PayPal e usa os botões personalizáveis Smart Payment Buttons™. Instalação Mais informações em: Instalar e ativar plugins/extensões. Requisitos Ajuste e configuração Para configurar o PayPal Checkout: Configurações da API Conecte uma conta PayPal nova ou existente. Configurações de finalização de \[…\]
