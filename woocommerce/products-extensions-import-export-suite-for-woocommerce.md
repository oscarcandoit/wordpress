---
url: https://woocommerce.com/documentation/products/extensions/import-export-suite-for-woocommerce
scraped_at: 2025-10-20T02:32:18.524Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/import-export-suite-for-woocommerce/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/import-export-suite-for-woocommerce/#page)
...
Import Export Suite for WooCommerce is an all-in-one WooCommerce import and export plugin that allows you to migrate or update all your WooCommerce data in a go! This includes the default WooCommerce fields, custom fields, and hidden metadata in bulk or based on your selection. Use cases Requirements Installation Sample CSVs Click the links to \[…\]

- [**Import and Export of WooCommerce Products**](https://woocommerce.com/document/import-and-export-of-woocommerce-products/)
Export and import all the products and their related data either from the WooCommerce store or e-commerce platforms using the plugin: Import export Suite for WooCommerce. Mapping WooCommerce Products Before you get down to the product import & export operation, you must have some knowledge about mapping fields. For example, the post\_title field gets mapped \[…\]
...
Importing and Exporting product reviews as shown in the documentation below requires the Import export Suite for WooCommerce extension. Importing and exporting product reviews and star ratings is not a feature of the free Core WooCommerce Plugin. Mapping of WooCommerce Product Reviews The plugin maps each field of a CSV/XML file to the field of \[…\]

- [**Import and Export of WooCommerce Orders**](https://woocommerce.com/document/import-and-export-of-woocommerce-orders/)
The Import export Suite for WooCommerce plugin lets you import and export all your WooCommerce orders from one store to another in an efficient manner. Mapping of WooCommerce Orders Column Heading Explanation Accepted value or format order\_id Identification Number of the order Numerical order\_number The sequential order number Numerical order\_date Date on which the order \[…\]

- [**Import and Export of WooCommerce Subscriptions**](https://woocommerce.com/document/import-and-export-of-woocommerce-subscriptions/)
Import export Suite for WooCommerce helps you to import and export all your WooCommerce subscriptions from one store to another in an efficient and quick manner. Mapping of WooCommerce Subscriptions Column Heading Explanation Accepted value or format subscription\_id Identification Number of the subscription. Numerical subscription\_status Status of the subscription Text. eg: Pending, On-hold customer\_id Identification \[…\]

- [**Import and Export of WooCommerce Users**](https://woocommerce.com/document/import-and-export-of-woocommerce-users/)
Export and import all your user and customer details from and to your WooCommerce store using the Import export Suite for WooCommerce. Mapping of WooCommerce Users Column Heading Explanation Accepted value or format ID Identification Number  Numerical customer\_id Identification Number of the customer. Numerical user\_login Can include: email, id, name. Alpha-numeric characters. user\_pass Login password \[…\]

- [**Import and Export of WooCommerce Coupons**](https://woocommerce.com/document/import-and-export-of-woocommerce-coupons/)
Coupons are the best tools to market your store products. With the plugin Import Export Suite for WooCommerce, you can quickly import and export all your WooCommerce coupons from one store to another. Mapping of WooCommerce Coupons Column Heading Explanation Accepted value or format post\_title Coupon code Alpha-numeric characters. ID Identification Number of the coupons \[…\]
