---
url: https://woocommerce.com/documentation/documentacao-em-portugues/analises-e-relatorios-de-vendas
scraped_at: 2025-10-20T02:24:34.256Z
---

[Skip to navigation](https://woocommerce.com/documentation/documentacao-em-portugues/analises-e-relatorios-de-vendas/#main-navigation) [Skip to content](https://woocommerce.com/documentation/documentacao-em-portugues/analises-e-relatorios-de-vendas/#page)
...
O Análises do WooCommerce é uma nova ferramenta de análise de dados e relatórios para ajudar você a gerenciar sua loja WooCommerce. O conjunto apresenta nove novos relatórios, juntamente com ferramentas de segmentação e filtros avançados, a capacidade de baixar todos os dados para CSV e um painel personalizável para monitorar todas as principais métricas \[…\]

- [**Painéis de Atividades**](https://woocommerce.com/document/paineis-de-atividades/)
O Painel de atividades visa ser um “balcão único” para o gerenciamento de sua loja – atender novos pedidos, gerenciar o estoque de produtos, moderar as avaliações e obter informações sobre o funcionamento da sua loja. Acesse os Painéis de atividades sempre que a barra de navegação do Administrador do WooCommerce for exibida, em qualquer \[…\]

- [**Widgets do Painel**](https://woocommerce.com/document/widgets-do-painel/)
Normalmente, o painel do WordPress é a primeira coisa que você visualiza ao fazer o login. Após a ativação, o WooCommerce adicionará dois widgets de painel, proporcionando um acesso mais fácil através de uma visão geral da sua loja, e um terceiro widget se você tiver um multisite com várias lojas. Para personalizar os widgets \[…\]
