---
url: https://woocommerce.com/documentation/products/extensions/composite-products
scraped_at: 2025-10-20T02:28:18.703Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/composite-products/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/composite-products/#page)
...
- ## Use Cases
  ...
  - [Use Case: Create Configurable Products](https://woocommerce.com/document/composite-products/composite-products-use-case-configurable-product/)
  - [Use Case: Create Step-by-Step Kit Builders](https://woocommerce.com/document/composite-products-use-case-kit-builder/)
  - [Use Case: Meal Subscription Delivery Service](https://woocommerce.com/document/use-case-meal-subscription-delivery-service/)
  - [See all topics](https://woocommerce.com/documentation/products/extensions/composite-products/composite-products-use-cases/)
...
Overview Composite Products allows you to create customizable product kits that consist of multiple, inventory-managed components, like this DSLR Camera Kit. Before you get started with Composite Products, make sure you’ve picked the right tool for the task at hand: Documentation Contents Store Owner’s Guide – Part I:Basic Setup Store Owner’s Guide – Part II:Beyond \[…\]

- [**Data Structures and Storage**](https://woocommerce.com/document/composite-products-data-structures-storage/)
Product Data Composite Products are stored in the database as custom post type entries of the product post type, similar to all product types in WooCommerce core. The extension introduces the Composite type by adding a composite term value to the product\_type taxonomy. All composite products are instances of the WC\_Product\_Composite class, which extends the \[…\]

- [**Extensions**](https://woocommerce.com/document/composite-products/composite-products-extensions/)
This document lists some popular official extensions and free plugins that add new functionality to Composite Products. Free Mini-Extensions To install a free mini-extension: Composite Products – Conditional Images Composite Products – Conditional Images is a free mini-extension for Composite Products that allows you to create dynamic, multi-layer Composite Product images that respond to Component \[…\]

- [**Feedback and Suggestions**](https://woocommerce.com/document/composite-products/composite-products-feedback-and-suggestions/)
...
- [**Filters Reference**](https://woocommerce.com/document/composite-products/composite-products-filters-reference/)
...
- [**Frequently Asked Questions**](https://woocommerce.com/document/composite-products/composite-products-faq/)
...
- [**Functions Reference**](https://woocommerce.com/document/composite-products/composite-products-functions-reference/)
Summary This guide introduces some of the most useful functions available in Composite Products. It does not include tutorials on how to achieve certain tasks. We recommend reading Data Structures and Storage before consulting this reference. Take time to familiarize yourself with the plugin architecture and the the WC\_CP\_Cart and WC\_CP\_Order objects. Shop Functions Summary \[…\]

- [**JavaScript API Reference**](https://woocommerce.com/document/composite-products/composite-products-js-api-reference/)
