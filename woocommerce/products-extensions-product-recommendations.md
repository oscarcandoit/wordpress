---
url: https://woocommerce.com/documentation/products/extensions/product-recommendations
scraped_at: 2025-10-20T02:36:23.189Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/product-recommendations/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/product-recommendations/#page)
...
- ## Recommendation Strategies
  ...
  - [Add “Frequently Bought Together” Recommendations in Product Pages](https://woocommerce.com/document/offer-frequently-bought-together-recommendations/)
  - [Display Cross-Sells in Product Pages](https://woocommerce.com/document/offer-category-based-cross-sells/)
  - [Offer “You May Also Like” Up-Sells by Category](https://woocommerce.com/document/product-recommendations/recommendation-strategies/offer-category-based-up-sells/)
  - [See all topics](https://woocommerce.com/documentation/products/extensions/product-recommendations/recommendation-strategies/)
...
This guide presents a collection of helpful tips and tricks to help you manage resources that generate recommendations and guarantee smooth operations during high demand. Woo Product Recommendations generates product recommendations on demand, in the background to conserve server resources and ensure proper functionality in all hosting environments. After creating and deploying a recommendation engine \[…\]

- [**Product Recommendations**](https://woocommerce.com/document/product-recommendations/)
Overview Product Recommendations is a product recommendations plugin for WooCommerce that lets you: Documentation Contents Just getting started? Read our Store Owner’s Guide to familiarize yourself with the basic concepts of the extension. Then, check out our high-performing Product Recommendation Strategies for ideas and inspiration. Getting Started Recommendation Strategies Advanced Topics FAQ & Feedback Troubleshooting & \[…\]

- [**Store Owner’s Guide**](https://woocommerce.com/document/product-recommendations/store-owners-guide/)
Requirements WooCommerce Product Recommendations requires WooCommerce 3.3+. Installation More information at: Install and Activate Plugins/Extensions. Configuration Product Recommendations allows you to build Engines that generate product recommendations based on custom filtering and sorting options. The generated recommendations can be conditionally displayed at various Locations of your store. If you are just starting out with Product \[…\]

- [**Product Recommendation Strategies**](https://woocommerce.com/document/product-recommendations/recommendation-strategies/)
This guide lists some of the most common, high-performing product recommendation strategies that you can implement with WooCommerce Product Recommendations. To quickly give you an idea of what the plugin can do for you, the listed strategies are organized by Location. Shop Page Recommend Best Selling Products Learn how to add a “Trending” block of \[…\]

- [**Frequently Asked Questions**](https://woocommerce.com/document/product-recommendations/frequently-asked-questions/)
Basic Functionality Product recommendations on my site are not rendered at all, or are rendered incorrectly. Issues with the display of product recommendations are commonly caused by page caching. It is also possible that your hosting configuration is preventing the extension from queuing and/or processing (re)generation tasks reliably. Diagnosing Issues Caused By Page Caching If \[…\]

- [**Feedback and Suggestions**](https://woocommerce.com/document/product-recommendations/feedback-and-suggestions/)
Don’t see a feature in Product Recommendations that you think would be useful? We’d love to hear it! You can leave a feature request for Product Recommendations here, where you can view and up-vote existing feature requests, or add your own. Or you can suggest it to our support team and we’ll consider adding it in \[…\]
