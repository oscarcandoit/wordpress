---
url: https://woocommerce.com/documentation/products/extensions/all-products-for-woocommerce-subscriptions
scraped_at: 2025-10-20T02:25:38.974Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/all-products-for-woocommerce-subscriptions/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/all-products-for-woocommerce-subscriptions/#page)
...
- ## Store Owner Guide
  ...
  - [See all topics](https://woocommerce.com/documentation/products/extensions/all-products-for-woocommerce-subscriptions/store-owner-guide/)
- ## Use Cases
  ...
  - [See all topics](https://woocommerce.com/documentation/products/extensions/all-products-for-woocommerce-subscriptions/all-products-for-woocommerce-subscriptions-use-cases/)
...
All Products for WooCommerce Subscriptions (APfS) follows standard WooCommerce development practices and conventions. While we’ve built it to work seamlessly with WooCommerce, interactions with third-party plugins may cause unexpected issues. Below you’ll find our current list of compatibility notes and known issues with other plugins. Supported Extensions We have tested and officially support the following \[…\]

- [**Snippets**](https://woocommerce.com/document/all-products-for-woocommerce-subscriptions/snippets/)
Use these snippets to customize the appearance and functionality of All Products for WooCommerce Subscriptions. Snippets Prevent subscription options from showing up next to cart-items The extension allows customers to switch the subscription plan of individual cart items. If you don’t want to display any subscription plan options next to cart items, use the following \[…\]

- [**Frequently Asked Questions**](https://woocommerce.com/document/all-products-for-woocommerce-subscriptions/frequently-asked-questions/)
Basic Functionality Is it possible to create subscription plans with Sign-Up fees and/or Free Trials? The subscription plans created with All Products For Subscriptions do not support Sign-Up Fees or Free Trials just yet! Does the extension support quick-pay buttons? No, All Products for WooCommerce Subscriptions does not support quick-pay buttons. I would like to \[…\]

- [**Feedback and Suggestions**](https://woocommerce.com/document/all-products-for-woocommerce-subscriptions/feedback-and-suggestions/)
Don’t see a feature in All Products for WooCommerce Subscriptions that you think would be useful? We’d love to hear it! The best place to start is the Ideas board, where you can view and up-vote existing feature requests, or add your own. Or suggest it to our support team and we’ll consider adding it in \[…\]
