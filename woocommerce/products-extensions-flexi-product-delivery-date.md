---
url: https://woocommerce.com/documentation/products/extensions/flexi-product-delivery-date
scraped_at: 2025-10-20T02:31:03.322Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/flexi-product-delivery-date/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/flexi-product-delivery-date/#page)
...
Appearance: Product Delivery Date Pro for WooCommerce Global settings – Calendar theme, Date & Time Formats As we all know, Product Delivery Date Pro for WooCommerce plugin is a one-stop solution to all product delivery requirements, be it for specific dates, recurring weekdays, or even particular time slots. But it is important that the appearance of the delivery calendar, the date and time formats, \[…\]
