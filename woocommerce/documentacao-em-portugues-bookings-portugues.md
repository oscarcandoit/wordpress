---
url: https://woocommerce.com/documentation/documentacao-em-portugues/bookings-portugues
scraped_at: 2025-10-20T02:26:10.842Z
---

[Skip to navigation](https://woocommerce.com/documentation/documentacao-em-portugues/bookings-portugues/#main-navigation) [Skip to content](https://woocommerce.com/documentation/documentacao-em-portugues/bookings-portugues/#page)
...
- ## Accommodation Bookings (Português)



  - [WooCommerce Accommodation (Hospedagem para o Reservas do WooCommerce)](https://woocommerce.com/document/woocommerce-accommodation-hospedagem-para-o-reservas-do-woocommerce/)
  - [See all topics](https://woocommerce.com/documentation/documentacao-em-portugues/bookings-portugues/accommodation-bookings-portugues/)
- ## Bookings Availability (Português)



  - [Disponibilidade de Reservas do WooCommerce (WooCommerce Bookings Availability)](https://woocommerce.com/document/disponibilidade-de-reservas-do-woocommerce-woocommerce-bookings-availability/)
  - [See all topics](https://woocommerce.com/documentation/documentacao-em-portugues/bookings-portugues/bookings-availability-portugues/)
...
Para aceitar reservas, você precisa criar um produto reservável. Vá para: Produtos > Adicionar novo. É exibida uma interface WooCommerce familiar para criação de produto. Insira um título e uma descrição para o seu produto. Role a página para baixo até Dados do produto e selecione Produto reservável no menu suspenso. Selecione a caixa de \[…\]

- [**Como Gerenciar as Reservas**](https://woocommerce.com/document/como-gerenciar-as-reservas/)
Lista de reservas Para visualizar todas as reservas que foram criadas, vá para Reservas no Painel. Uma lista de reservas será exibida em ordem cronológica inversa (da mais recente para a mais antiga). Para filtrar as reservas, selecione as opções no menu na parte superior. Filtrar por: Status Data Produto/Recurso Para usar ações em massa, \[…\]

- [**Como Usar os Recursos nas Reservas**](https://woocommerce.com/document/como-usar-os-recursos-nas-reservas/)
Os recursos podem ser adicionados em vários produtos reserváveis ​​com uma disponibilidade de nível global ou disponibilidade individual. Exemplos de uso incluem: Um assistente que pode ser contratado para organizar um casamento ou uma festa de aniversário de 50 anos, mas não os dois ao mesmo tempo. Uma sala que pode ser alugada para uma \[…\]

- [**Configurações do WooCommerce Bookings (Reservas do WooCommerce)**](https://woocommerce.com/document/configuracoes-do-woocommerce-bookings-reservas-do-woocommerce/)
As configurações do WooCommerce Bookings (Reservas do WooCommerce) podem ser encontradas em Reservas > Configurações a partir da versão 1.13. Store Availability (Disponibilidade da loja) Timezones (Fusos horários) Calendar Connection (Conexão do calendário) Antes da versão 1.13x, algumas configurações estavam localizadas em WooCommerce > Configurações. Disponibilidade da loja As regras de disponibilidade da loja se \[…\]

- [**Integração com Product Add-Ons (Complementos de produto)**](https://woocommerce.com/document/integracao-com-product-add-ons-complementos-de-produto/)
O WooCommerce Bookings (Reservas do WooCommerce) é compatível com Product Add-Ons (Complementos de produto) (Disponível somente em inglês) (vendidos separadamente). Usados ​​juntos, você pode criar formulários de reserva melhores com opções adicionais. A configuração de complementos para produtos reserváveis é igual a outros tipos de produto, com exceção das opções Add-ons (Complementos). O WooCommerce Bookings \[…\]

- [**Integração do Google Agenda com o Reservas do WooCommerce**](https://woocommerce.com/document/integracao-do-google-agenda-com-o-reservas-do-woocommerce/)
Para conectar o Reservas do WooCommerce com seu Google Agenda, é necessário ter: WooCommerce Bookings (Reservas do WooCommerce) Conta Google – nova ou existente Instalação e configuração O Reservas do WooCommerce oferece dois métodos diferentes que você pode usar para se conectar ao seu Google Agenda: 1) Método de conexão fornecido pelo WooCommerce.com. Esse método \[…\]

- [**Perguntas Frequentes sobre Reservas**](https://woocommerce.com/document/perguntas-frequentes-sobre-reservas/)
Respostas às perguntas mais frequentes sobre o WooCommerce Bookings (Reservas do WooCommerce) (Disponível somente em inglês). Nós recomendamos a leitura do guia Primeiros passos com o Reservas do WooCommerce, caso você ainda não tenha lido. Por que eu não consigo realizar a finalização da compra com outros produtos usando a opção Requer confirmação? Como um \[…\]

- [**Primeiros passos com o Reservas do WooCommerce**](https://woocommerce.com/document/primeiros-passos-com-o-reservas-do-woocommerce/)
O Reservas do WooCommerce (disponível somente em inglês) é uma extensão premium do WooCommerce. A extensão Reservas do WooCommerce permite que você configure os produtos reserváveis para reservas, serviços e aluguéis/contratações. As reservas pode ter duração, custos e datas personalizáveis e podem ser adquiridas de maneira semelhante a outros produtos WooCommerce. Instalação Baixe o arquivo \[…\]

- [**Processo de reserva do cliente**](https://woocommerce.com/document/processo-de-reserva-do-cliente/)
Formulário de reserva Um formulário de reserva é gerado para o formulário de Adicionar ao carrinho do site. Isso é definido de acordo com a forma como o produto foi configurado. Abaixo está um exemplo de reserva definida por horário, por hora. Se vários espaços estão disponíveis por bloco, o número de vagas restantes é \[…\]
