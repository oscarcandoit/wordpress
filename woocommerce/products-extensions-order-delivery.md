---
url: https://woocommerce.com/documentation/products/extensions/order-delivery
scraped_at: 2025-10-20T02:34:08.241Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/order-delivery/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/order-delivery/#page)
...
Learn how the section appears and works so that your customers can choose the date they would like to receive their order.

- [**Delivery fees**](https://woocommerce.com/document/woocommerce-order-delivery/delivery-fees/)
Order Delivery allows you to charge additional costs (fees) to the customers for choosing a specific day of the week or a delivery time frame. Some examples of applicable fees are: Add a fee To add a delivery fee: Note: When a delivery day is split into time frames, the fees must be specified within \[…\]

- [**Delivery ranges**](https://woocommerce.com/document/woocommerce-order-delivery/delivery-ranges/)
Learn how to configure the Order Delivery extension to define different delivery ranges based on delivery times.

- [**Getting Started with Order Delivery**](https://woocommerce.com/document/woocommerce-order-delivery/getting-started/)
Getting started with Order Delivery for WooCommerce and learning how this extension works.

- [**Next day delivery**](https://woocommerce.com/document/woocommerce-order-delivery/next-day-delivery/)
Learn how to set up the extension Order Delivery so your customers can receive orders on the next day.

- [**Order Delivery Details**](https://woocommerce.com/document/woocommerce-order-delivery/order-details/)
Learn where and how the order delivery details are reflected in the various locations of your store and in emails.

- [**Order Delivery FAQ**](https://woocommerce.com/document/woocommerce-order-delivery/faq/)
Order Delivery FAQs

- [**Order Delivery Integrations**](https://woocommerce.com/document/woocommerce-order-delivery/integrations/)
A list of WooCommerce extensions and WordPress plugins that Order Delivery adds compatibility with.

- [**Order Delivery Troubleshooting**](https://woocommerce.com/document/woocommerce-order-delivery/troubleshooting/)
Order Delivery Troubleshooting

- [**Same day delivery**](https://woocommerce.com/document/woocommerce-order-delivery/same-day-delivery/)
Learn how to set up the extension Order Delivery so that your customers can receive orders on the same day.
