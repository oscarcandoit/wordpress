---
url: https://woocommerce.com/documentation/documentacao-em-portugues/como-instalar-e-atualizar
scraped_at: 2025-10-20T02:23:09.211Z
---

[Skip to navigation](https://woocommerce.com/documentation/documentacao-em-portugues/como-instalar-e-atualizar/#main-navigation) [Skip to content](https://woocommerce.com/documentation/documentacao-em-portugues/como-instalar-e-atualizar/#page)
...
Ter uma plataforma de comércio eletrônico personalizável significa que existem muitas configurações disponíveis que precisam ser configuradas. O Assistente de configuração ajuda você em todas as etapas necessárias para configurar sua loja e deixá-la pronta para iniciar as vendas de seus produtos! Logo após ativar o plugin, você é direcionado ao Criador de perfil da \[…\]

- [**Atualizar PHP e WordPress**](https://woocommerce.com/document/atualizar-php-e-wordpress/)
Para otimizar a segurança e o desempenho da sua loja WooCommerce, ela deverá estar sendo executada com as versões mínimas de PHP e WordPress suportadas. Isto mantém sua loja WooCommerce funcionando sem problemas e cria a melhor experiência online para todos os seus clientes. Requisitos mínimos do WooCommerce A versão mais recente do WooCommerce e \[…\]

- [**Começar com o WooCommerce em 5 etapas**](https://woocommerce.com/document/comecar-com-o-woocommerce-em-5-etapas/)
Neste guia de primeiros passos, nós ensinamos você sobre como configurar um site com o WooCommerce. Escolher a hospedagem Você precisa executar o WordPress em um site com hospedagem própria (self-hosted). Temos parceria com algumas empresas de hospedagem que oferecem pré-instalações de WordPress, WooCommerce, nosso tema Storefront e recursos específicos para comércio eletrônico, como um \[…\]

- [**Como atualizar o WooCommerce**](https://woocommerce.com/document/como-atualizar-o-woocommerce/)
Atualizações no WooCommerce, Storefront, WordPress e suas extensões e métodos de pagamento são situações da vida. Nossa equipe de desenvolvedores trabalha arduamente lançando atualizações que adicionam novos recursos, corrigem problemas, aumentam a segurança e, em geral, tornam sua loja melhor do que nunca. Mas como você atualiza o WooCommerce sem causar problemas? Abordaremos algumas das \[…\]

- [**Como Escolher o Tema Certo**](https://woocommerce.com/document/como-escolher-o-tema-certo/)
Escolher o tema certo do WooCommerce será certamente muito subjetivo. Como dizem, “A beleza está nos olhos de quem vê”. Mas a aparência é apenas superficial. Abaixo estão algumas dicas a serem consideradas antes de escolher um tema para a sua loja. Aparência estética Não procure apenas por um tema que ‘parece bom’. O tema \[…\]

- [**Como gerenciar as assinaturas do WooCommerce.com**](https://woocommerce.com/document/como-gerenciar-as-assinaturas-do-woocommerce-com/)
As assinaturas para produtos adquiridos no WooCommerce.com são exibidas em uma aba no seu administrador do WordPress: WP-Admin > WooCommerce > Extensões. Para visualizar e gerenciar suas assinaturas aqui, você precisará conectar seu site ao WooCommerce.com. Quando seu site estiver conectado, suas extensões serão atualizadas automaticamente. Suas assinaturas também estão listadas no seu painel no \[…\]

- [**Como Instalar e Desinstalar o WooCommerce**](https://woocommerce.com/document/como-instalar-e-desinstalar-o-woocommerce/)
O plugin do WooCommerce pode ser instalado e desinstalado da mesma maneira que outros plugins do WordPress. A instalação e configuração completa do WooCommerce em seu site é uma etapa adicional e opcional para ajudar na configuração completa e está disponível no Assistente de configuração. Revise os requisitos do servidor antes da instalação ou poderá \[…\]

- [**Endpoints do WooCommerce**](https://woocommerce.com/document/endpoints-do-woocommerce/)
Os endpoints são uma parte adicional no URL do site que é detectado, quando está presente, para exibir um conteúdo diferente. Por exemplo: Você pode ter uma página ‘minha conta’ exibida no URL seusite.com/minha-conta. Quando o endpoint ‘editar-conta’ é acrescentado a este URL, ou seja, ‘seusite.com/minha-conta/editar-conta‘ então a página Editar conta é exibida em vez \[…\]

- [**Páginas do WooCommerce**](https://woocommerce.com/document/paginas-do-woocommerce/)
Após a instalação, o WooCommerce cria as novas páginas a seguir, através do Assistente de instalação: Instalar páginas novamente Se você pulou o Assistente de instalação ou deseja instalar as páginas ausentes do WooCommerce, vá para WooCommerce > Status > Ferramentas e use a ferramenta do instalador de página. Informe ao WooCommerce quais páginas usar \[…\]

- [**Recomendações de servidor**](https://woocommerce.com/document/recomendacoes-de-servidor/)
Recomendado A primeira etapa para configurar sua loja online com o WooCommerce é instalar o WordPress e o plugin do WooCommerce. Mas antes de fazer isso, você deve verificar seu ambiente de hospedagem. Como um guia, nós recomendamos: PHP versão 7.2 ou superior MySQL versão 5.6 ou superior OU MariaDB versão 10.0 ou superior Limite \[…\]
