---
url: https://woocommerce.com/documentation/products/extensions/photography/photography-use-cases
scraped_at: 2025-10-20T02:41:19.384Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/photography/photography-use-cases/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/photography/photography-use-cases/#page)
...
You can allow your customers to choose a print lab in your store if you do not have one. You will take care of sending the purchased photographs to the chosen print lab, get them back and send them to the customer. Requirements WooCommerce Photography WooCommerce Product Add-ons WooCommerce Checkout Field Editor (optional) Configuration In the \[…\]

- [**Wedding Photographer**](https://woocommerce.com/document/woocommerce-photography-use-case-wedding/)
You are a wedding photographer and want to explore the world of Internet. It’s a great way to show your work and get more customers. You build a site and you need to sell the photos of your last wedding. Requirements WooCommerce WooCoommerce Photography Configuration You want to share the photos only to the bride and \[…\]
