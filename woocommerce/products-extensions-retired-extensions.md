---
url: https://woocommerce.com/documentation/products/extensions/retired-extensions
scraped_at: 2025-10-20T02:36:56.144Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/retired-extensions/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/retired-extensions/#page)
...
The 2Checkout API Gateway plugin extends WooCommerce allowing you to take payments directly on your store via the 2Checkout API. Installation More information at: Install and Activate Plugins/Extensions. Requirements Setup and Configuration Usage Customers pay on the checkout page. After selecting the 2Checkout payment gateway, credit card fields will appear. Troubleshooting Root Relative URLs There are \[…\]

- [**2Checkout Form**](https://woocommerce.com/document/2checkout-2/)
2Checkout Gateway is a plugin that extends WooCommerce, allowing you to take payments via 2Checkout. This plugin utilizes the 2CO Pass-Through-Products Parameters that enables you to use the gateway without having to create products in the 2CO sellers area. General information When the order goes through, the user is taken to 2CO to make a secure \[…\]

- [**2Checkout Inline Checkout**](https://woocommerce.com/document/2checkout-inline-checkout/)
2Checkout Inline Checkout creates an iFrame checkout option that displays a secure payment form inside your WooCommerce store and allows you to process transactions from 196 countries using 26 currencies and 15 languages. Installation More information at: Install and Activate Plugins/Extensions. Requirements Sign up with 2Checkout In the 2Checkout Seller Area, find your Account Number at the \[…\]

- [**Acutrack Webservice**](https://woocommerce.com/document/acutrack-webservice/)
Acutrack / Woocommerce Order Notification Setup Note: To enable the REST API within Woocommerce, go to Woocommerce > Settings > API tab and tick the Enable REST API checkbox. Configure Acutrack Webservice

- [**AntsRoute – Delivery Scheduling and Optimization**](https://woocommerce.com/document/antsroute-delivery-scheduling-and-optimization/)
The AntsRoute module simplifies issues regarding local delivery for online sales sites. Online sellers can automatically delegate their deliveries to a carrier or organize them by their own resources.   Requirements Minimum PHP version: 5.2. Having subscribed to AntsRoute. Available in Africa, Europe, North-America and South-America.   Installation Download the .zip file from your woocommerce.com account. \[…\]

- [**Bazaar Multivendor Platform for WooCommerce**](https://woocommerce.com/document/bazaar-multivendor-platform-for-woocommerce/)
Bazaar Multivendor Platform for WooCommerce is the most popular plugin on the WordPress platform. The CodexInfra team had created this great platform for the convenience of the WooCommerce site to allow Multiple vendors for selling their products and with a great UI.This plugin purely works on Ajax so there will be no reloading all over \[…\]

- [**BluePay**](https://woocommerce.com/document/bluepay-2/)
BluePay is credit card processing, simplified. This gateway also provides BluePay eCheck functionality. Requirements An SSL certificate – see SSL and HTTPS for free and low-cost options An active gateway Merchant account with BluePay Installation Download the .zip file from your WooCommerce account. Go to: WordPress Admin > Plugins > Add New and Upload Plugin with \[…\]

- [**Booster Multi-Currency Switcher**](https://woocommerce.com/document/booster-multicurrency-switcher/)
Stores with an international customer base allow their customers to make purchases in a variety of currencies.  Booster Multi-Currency Switcher plugin is a currency converter that displays prices in a customer’s chosen currency. This plugin has 3 modules: Currency you add to your store, featuring real-time conversion rate.  You can also set the Currency rate \[…\]

- [**Booster Price and Currencies By Country**](https://woocommerce.com/document/booster-price-and-currencies-by-country/)
Give your customers a better and more seamless purchase experience by listing your products with their local currency. When enabled, WooCommerce Prices and Currencies by Country module will automatically detect your customers’ countries by their IP address and they’ll see products in their country’s currency. If you wish to carry the customer’s currency all the \[…\]

- [**Bulk Product Edit with Google Sheets**](https://woocommerce.com/document/bulk-product-sync-with-google-sheets/)
What is Bulk Product Sync (BPS) Plugin? The Bulk Product Sync plugin, often referred to as BPS, is a robust WooCommerce extension designed to streamline and simplify the management of your online store’s products and categories. This essential tool empowers e-commerce specialists, developers, and store owners by offering a seamless integration with Google Sheets™. With \[…\]
