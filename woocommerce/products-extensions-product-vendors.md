---
url: https://woocommerce.com/documentation/products/extensions/product-vendors
scraped_at: 2025-10-20T02:36:32.716Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/product-vendors/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/product-vendors/#page)
...
Overview Below we have a range of questions that are often asked about the Product Vendors. If a solution requires some form of custom code, then the team at WooCommerce.com support cannot help with that as per our Support Policy. Which payment gateways can I use? Any payment gateway can be used to accept payments \[…\]

- [**Vendor Guide**](https://woocommerce.com/document/vendor-guide/)
Product Vendors 2.0x gives vendors more options and control of their store. Registration Potential vendors can register via a registration form. Once a vendor has submitted the form, the Store Owner gets an email notification that a vendor has applied and a user account is created for the vendor. A status/role of Pending Vendor is assigned until the \[…\]
