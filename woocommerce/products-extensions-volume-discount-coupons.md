---
url: https://woocommerce.com/documentation/products/extensions/volume-discount-coupons
scraped_at: 2025-10-20T02:42:00.735Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/volume-discount-coupons/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/volume-discount-coupons/#page)
...
- [**Installation**](https://woocommerce.com/document/volume-discount-coupons/installation/)
Volume Discount Coupons is an extension for WooCommerce. Use of the latest versions of WordPress and WooCommerce is recommended. Install and activate the Volume Discount Coupons plugin: The extension is basically setup-free and can be used right away after it has been installed and activated. Existing coupons and new coupons will have the Volume Discount tab available to \[…\]

- [**Shortcodes**](https://woocommerce.com/document/volume-discount-coupons/shortcodes/)
The Volume Discount Coupons extension provides the following shortcodes: These shortcodes require the indication of the coupon code via the code attribute, for example: \[volume\_discount\_coupon code=”test”\] … would render a pretty coupon for the coupon whose code is test. Here are examples of several pretty coupons rendered on the Coupons demo page: The first coupon \[…\]
