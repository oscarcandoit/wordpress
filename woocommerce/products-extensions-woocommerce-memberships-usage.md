---
url: https://woocommerce.com/documentation/products/extensions/woocommerce-memberships/usage
scraped_at: 2025-10-20T02:41:08.737Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/woocommerce-memberships/usage/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/woocommerce-memberships/usage/#page)
...
- [**WooCommerce Memberships Directory Shortcode**](https://woocommerce.com/document/woocommerce-memberships-directory-shortcode/)
Overview WooCommerce Memberships includes a \[wcm\_directory\] shortcode that lets you publicly display members on your site within a directory. By passing certain arguments into the shortcode, you can opt to show members of only certain plans or statuses, and this shortcode can be included in a restricted page as well to keep it private for \[…\]

- [**WooCommerce Memberships Import and Export**](https://woocommerce.com/document/woocommerce-memberships-import-and-export/)
Memberships has a native CSV import / export that will allow you to: import a CSV of your members to update or merge membership data import a CSV of members to create new memberships (and even create new user accounts if needed) export all members, or export members based on status, plan, start date, or \[…\]

- [**WooCommerce Memberships Plans**](https://woocommerce.com/document/woocommerce-memberships-plans/)
Membership plans dictate how WooCommerce Memberships should restrict content and apply membership perks, such as discounts, for members and non-members. Plans can create access rules for posts, pages, products, and other content/custom post types, such as portfolio items (depending on how this content is created). Access rules can determine whether all users or only members \[…\]

- [**WooCommerce Memberships Profile Fields**](https://woocommerce.com/document/woocommerce-memberships-profile-fields/)
Overview Memberships offers profile fields so you can gather and store important information about your members to help you support and market your memberships more effectively. In this document, we’ll cover how to create and manage profile fields, as well as how they impact the member experience. Requirements Memberships v1.19+ Teams for Memberships v1.5+, to \[…\]

- [**WooCommerce Memberships Restrict Content**](https://woocommerce.com/document/woocommerce-memberships-restrict-content/)
WooCommerce Memberships provides several methods for restricting content on your site. You can restrict content while creating or editing a membership plan, by adding rules from the Memberships meta box while editing content, or by using a shortcode. Note that if no rules are applied to content, that content is publicly accessible. Once a rule \[…\]

- [**WooCommerce Memberships Settings**](https://woocommerce.com/document/woocommerce-memberships-settings/)
This document offers details on WooCommerce Memberships settings and content restriction modes. Memberships allows you to determine how your restricted content should be presented to non-members and lets you control the messaging used when content is restricted. If you’d like to index some of your protected content for SEO, you can do so with excerpts \[…\]

- [**WooCommerce Memberships User Memberships**](https://woocommerce.com/document/woocommerce-memberships-user-memberships/)
WooCommerce Memberships allows your customers to have one or more memberships, and these can be purchased or manually assigned by a shop admin / manager. Memberships are activated once an order is paid for (processing or completed status) that includes a product that grants access to the membership. They can also be activated manually by \[…\]
