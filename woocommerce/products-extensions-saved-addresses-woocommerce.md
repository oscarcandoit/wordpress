---
url: https://woocommerce.com/documentation/products/extensions/saved-addresses-woocommerce
scraped_at: 2025-10-20T02:37:04.817Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/saved-addresses-woocommerce/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/saved-addresses-woocommerce/#page)
...
Saved Addresses For WooCommerce allows logged-in (registered) users to save multiple shipping and billing addresses during checkout. Speed up the checkout process and increase conversions. Installation More information at: Installing and Managing Plugins. Enable plugin updates Please follow the steps listed here to enable plugin updates for Saved Addresses For WooCommerce. Setup and Configuration This plugin \[…\]

- [**How to override templates**](https://woocommerce.com/document/saved-addresses-for-woocommerce/how-to-override-templates/)
Saved Addresses For WooCommerce allows logged-in (registered) users to save multiple shipping and billing addresses during checkout. Thus it speeds up the checkout process and increases conversions. A logged-in user can also manage all their addresses from their account. This doc article explains how to replace/override plugin templates. Override template via another template file All \[…\]
