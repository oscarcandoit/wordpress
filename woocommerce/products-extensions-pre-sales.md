---
url: https://woocommerce.com/documentation/products/extensions/pre-sales
scraped_at: 2025-10-20T02:35:51.067Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/pre-sales/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/pre-sales/#page)
...
- [**How Many Products Can WooCommerce Handle?**](https://woocommerce.com/document/how-many-products-can-woocommerce-handle/)
...
- [**How to bundle products with WooCommerce**](https://woocommerce.com/document/group-bundle-products-woocommerce/)
...
- [**Premium Shipping Method Comparison**](https://woocommerce.com/document/premium-shipping-extension-options/)
...
- [**Pro Add-on for WooCommerce Dropshipping**](https://woocommerce.com/document/pro-add-on-for-woocommerce-dropshipping/)
...
- [**Role & Customer Based Pricing by Meow Crew**](https://woocommerce.com/document/role-and-customer-based-pricing-by-meow-crew/)
...
- [**WooCommerce Paytrail**](https://woocommerce.com/document/suomen-verkkomaksut/)
Overview The WooCommerce Paytrail plugin (formerly Suomen Verkkomaksut) extends WooCommerce allowing you to take payments via Paytrail payment portal. You need to register for a contract with Paytrail to use this plugin. Installation Setup and Configuration First, you must log in to your Paytrail account and copy your Merchant ID and Merchant Secret / Password. These \[…\]

- [**WooCommerce Scaling FAQs**](https://woocommerce.com/document/woocommerce-scaling-faqs/)
Contrary to a persistent myth, WordPress and WooCommerce scale very effectively to work equally well for large enterprises and small stores alike. We believe in using our own software, which is why WooCommerce.com runs on both WordPress and WooCommerce, handling a large number of products, customers, orders, subscriptions, and transactions. Here are questions we get most \[…\]
