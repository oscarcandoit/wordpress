---
url: https://woocommerce.com/documentation/snippets/general-snippets
scraped_at: 2025-10-20T02:31:29.615Z
---

[Skip to navigation](https://woocommerce.com/documentation/snippets/general-snippets/#main-navigation) [Skip to content](https://woocommerce.com/documentation/snippets/general-snippets/#page)
...
- [**Add/Modify States**](https://woocommerce.com/document/addmodify-states/)
...
- [**Adjust the quantity input values**](https://woocommerce.com/document/adjust-the-quantity-input-values/)
...
- [**Allow shortcodes in product excerpts**](https://woocommerce.com/document/allow-shortcodes-in-product-excerpts/)
...
- [**Allowing customer access to WP Admin, and enabling the admin bar**](https://woocommerce.com/document/allowing-customer-access-to-wp-admin-and-enabling-the-admin-bar/)
...
- [**Automatically add product to cart on visit**](https://woocommerce.com/document/automatically-add-product-to-cart-on-visit/)
Add code to your child theme’s functions.php file or via a plugin that allows custom functions to be added, such as the Code snippets plugin. Avoid adding custom code directly to your parent theme’s functions.php file as this will be wiped entirely when you update the theme. If you want to automatically add a product \[…\]

- [**Change a currency symbol**](https://woocommerce.com/document/change-a-currency-symbol/)
...
- [**Change email subject lines**](https://woocommerce.com/document/change-email-subject-lines/)
Add code to your child theme’s functions.php file or via a plugin that allows custom functions to be added, such as the Code snippets plugin. Avoid adding custom code directly to your parent theme’s functions.php file as this will be wiped entirely when you update the theme.
