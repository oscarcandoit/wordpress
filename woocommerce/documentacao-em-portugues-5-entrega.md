---
url: https://woocommerce.com/documentation/documentacao-em-portugues/5-entrega
scraped_at: 2025-10-20T02:24:03.826Z
---

[Skip to navigation](https://woocommerce.com/documentation/documentacao-em-portugues/5-entrega/#main-navigation) [Skip to content](https://woocommerce.com/documentation/documentacao-em-portugues/5-entrega/#page)
...
- ## Opções de Entrega Básicas
  ...
  - [See all topics](https://woocommerce.com/documentation/documentacao-em-portugues/5-entrega/opcoes-de-entrega-basicas/)
...
Se os custos de entrega fornecidos pela instalação do WooCommerce forem maiores ou menores do que o esperado, nós recomendamos ativar o modo de depuração na seção de configurações do plugin do método de entrega que você está usando. Depois que esta opção estiver ativada, adicione um produto ao carrinho e, na maioria dos casos, \[…\]

- [**Como configurar as Áreas de Entrega**](https://woocommerce.com/document/como-configurar-as-areas-de-entrega/)
Vendendo produtos físicos? Você precisa enviá-los! Para configurar a entrega no WooCommerce, primeiro você precisa configurar as áreas de entrega e, em seguida, adicionar métodos para estas áreas e, por último, as taxas para os seus métodos. Você pode criar quantas áreas desejar e adicionar vários métodos e taxas para cada área. Áreas de entrega \[…\]
...
Em alguns de nossos métodos de entrega premium — como USPS, UPS, e FedEx (disponíveis somente em inglês) — as embalagens usadas para realizar a entrega de produtos são calculadas automaticamente com base nas dimensões dos itens no carrinho do cliente. Esta página detalha como as calculadoras de entrega funcionam e maneiras nas quais você \[…\]
