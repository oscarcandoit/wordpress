---
url: https://woocommerce.com/documentation/products/extensions/product-csv-import-suite
scraped_at: 2025-10-20T02:36:03.768Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/product-csv-import-suite/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/product-csv-import-suite/#page)
...
This documentation is for the premium Product CSV Import Suite extension. If you’re looking for documentation about the default product importer built-in in WooCommerce, see that documentation here. Here is an extensive list of column headers you can use in your CSV for all default product types in WooCommerce. You can download a sample CSV \[…\]
...
The Product CSV Import Suite has been designed to seamlessly integrate with the default product types that come with WooCommerce. It empowers you to segment your product CSV into separate files for normal products and variations. Furthermore, the following extensions have been tested to work with Product CSV Import Suite and are officially supported. Supported \[…\]
...
Export Settings Navigate to WooCommerce > CSV Import Suite > Export Products. You can then choose to export either products or product variations. CSV Export Options There are a number of options for your export: Limit – the maximum number of products that you wish to export. For example, if you had a limit of 100 and an offset of 200, you \[…\]

- [**FAQ / Troubleshooting**](https://woocommerce.com/document/product-csv-import-suite/product-csv-import-suite-faq-troubleshooting/)
Common issues and answers/solutions for the Product CSV Import Suite. What CSV editors do you recommend? We recommend using: If possible, avoid Microsoft Excel due to formatting and character encoding issues. What is the best way to create a CSV? To create a CSV for your shop: Do I need to import images to the \[…\]

- [**Importing Product Variations**](https://woocommerce.com/document/product-csv-import-suite/product-csv-import-suite-importing-product-variations/)
Product CSV Import Suite can also import product variations, although it does so with a separate, for-variations CSV. Below is an example to illustrate. Example Product and CSV files Follow along by downloading the two CSV files with minimal column headers: This is how it will look in the back-end: And here’s what customers will \[…\]

- [**Importing Products**](https://woocommerce.com/document/product-csv-import-suite/product-csv-import-suite-importing-products/)
Importing your products can be as nice and simple as creating a CSV file and importing that into WooCommerce. Create Your CSV To get you started, you can find a sample.csv in the plugin folder, or download one here. This has many of the common fields used for selling products. For a complete list of fields available, \[…\]

- [**Introduction to Product CSV Import Suite**](https://woocommerce.com/document/product-csv-import-suite/)
The Product CSV Import Suite WooCommerce extension lets you import and export products to and from WooCommerce. It streamlines the process of importing large quantities of products using a single file. You can import hundreds, even thousands, of products using one file. Product CSV Import Suite captures custom field information, without requiring custom code, so \[…\]

- [**Merging Products and Variations**](https://woocommerce.com/document/product-csv-import-suite/product-csv-import-suite-merging-products-and-variations/)
If you make changes to products, you may wish to update your CSV and merge changes with your current products. Create Your CSV Create a CSV, or make changes to your current CSV. To ensure that changes are mapped to the right place, you must include one of the following columns: post\_id sku Note that merging new \[…\]
