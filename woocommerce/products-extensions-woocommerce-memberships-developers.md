---
url: https://woocommerce.com/documentation/products/extensions/woocommerce-memberships/developers
scraped_at: 2025-10-20T02:28:32.788Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/woocommerce-memberships/developers/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/woocommerce-memberships/developers/#page)
...
Overview You can manage WooCommerce Memberships plans and members via WP CLI if installed in your environment. There are two additional subcommands added to the WC CLI implementation: user\_membership and membership\_plan. For further details please see the CLI help topics: wp help wc user\_membership and wp help wc membership\_plan. All versions can still use our \[…\]
...
- [**WooCommerce Memberships Data Structure**](https://woocommerce.com/document/woocommerce-memberships-data-structure/)
...
- [**WooCommerce Memberships Frontend Hook Reference**](https://woocommerce.com/document/woocommerce-memberships-hook-reference/)
For Developers: Frontend Hook Reference WooCommerce Memberships is extremely extensible and offers ample actions and filters for developers to customize it as needed. If a hook doesn’t exist where you think it should, please submit a ticket so we can consider its addition. This hook reference includes some of the actions and filters developers may \[…\]

- [**WooCommerce Memberships Function Reference**](https://woocommerce.com/document/woocommerce-memberships-function-reference/)
For Developers: Checks & Functions WooCommerce Memberships provides several methods for checking data on content restriction and user memberships. This reference includes helpful conditional checks and global functions for Memberships. Conditional checks return bool true or false. For example: if ( wc\_memberships\_is\_product\_viewing\_restricted() ) { echo ‘MARCO!’; } else { echo ‘POLO!’; } This would check \[…\]

- [**WooCommerce Memberships Snippet Samples**](https://woocommerce.com/document/woocommerce-memberships-snippet-samples/)
