...
scraped_at: 2025-10-20T02:22:25.094Z
---

[Skip to navigation](https://woocommerce.com/documentation/woocommerce/#main-navigation) [Skip to content](https://woocommerce.com/documentation/woocommerce/#page)
...
Build exactly the ecommerce website you want with WooCommerce — a customizable, open-source ecommerce platform built on WordPress.

```
Are you a developer?  [Click here for technical documentation](https://developer.woocommerce.com/docs/).
```
...
Everything you’ll need to get your online store up and running. From installation to managing orders — our guides can help with configuring WooCommerce to work for your business.
  ...
  - [See all topics](https://woocommerce.com/documentation/woocommerce/getting-started/)
...
**Ready to switch platforms?** Our migration guides help you confidently move your store to WooCommerce. Whether you're just exploring or already planning the transition, you'll find step-by-step resources to get set up, transfer your data, and unlock the flexibility and control that come with owning your store.
  ...
  - [Importing products from Etsy](https://woocommerce.com/document/importing-products-from-etsy/)
  - [Migrating products between sites](https://woocommerce.com/document/migrating-products-between-sites/)
  - [See all topics](https://woocommerce.com/documentation/woocommerce/migrating-to-woocommerce/)
- ## Products
  ...
  - [See all topics](https://woocommerce.com/documentation/woocommerce/core-products/)
- ## Taxes



  - [Setting Up EU VAT Rates for Digital Products](https://woocommerce.com/document/setting-up-taxes-in-woocommerce/configuring-specific-tax-setups-in-woocommerce/setting-up-eu-vat-rates-for-digital-products/)
  - [EU VAT July 2021 changes, eCommerce, and WooCommerce](https://woocommerce.com/document/eu-vat-july-2021-changes-ecommerce-and-woocommerce/)
  ...
  - [See all topics](https://woocommerce.com/documentation/woocommerce/taxes/)
- ## Shipping
  ...
  - [See all topics](https://woocommerce.com/documentation/woocommerce/shipping/)
- ## Payments
  ...
  - [Which payment option is right for me?](https://woocommerce.com/document/premium-payment-gateway-extensions/)
  - [See all topics](https://woocommerce.com/documentation/woocommerce/payments/)
- ## Orders
  ...
  - [See all topics](https://woocommerce.com/documentation/woocommerce/orders/)
- ## Data and Reporting



  - [Analytics and Sales Reports](https://woocommerce.com/document/woocommerce-analytics/)
  - [Dashboard Widgets](https://woocommerce.com/document/dashboard-widgets/)
  - [WooCommerce Analytics: Order Attribution Report](https://woocommerce.com/document/woocommerce-analytics/order-attribution-report/)
  - [See all topics](https://woocommerce.com/documentation/woocommerce/data-reporting/)
- ## Customers
  ...
  - [See all topics](https://woocommerce.com/documentation/woocommerce/customers/)
- ## Marketing



  - [Managing Coupons in WooCommerce](https://woocommerce.com/document/coupon-management/)
  - [Google for WooCommerce](https://woocommerce.com/document/google-for-woocommerce/)
  - [Email troubleshooting](https://woocommerce.com/document/email-faq/)
  - [See all topics](https://woocommerce.com/documentation/woocommerce/marketing/)
- ## Site Administration
  ...
  - [Updating free WooCommerce extensions/plugins](https://woocommerce.com/document/updating-free-woocommerce-plugins/)
  - [See all topics](https://woocommerce.com/documentation/woocommerce/site-admin/)
- ## Store Design



  - [WooCommerce store editing](https://woocommerce.com/document/woocommerce-store-editing/)
  - [Widgets included with WooCommerce](https://woocommerce.com/document/woocommerce-widgets/)
  - [See all topics](https://woocommerce.com/documentation/woocommerce/store-design/)
- ## Mobile App
  ...
  - [See all topics](https://woocommerce.com/documentation/woocommerce/mobile/)
- ## Get help
...
Start here: our [troubleshooting guide](https://woocommerce.com/document/woocommerce-self-service-guide/) addresses some of the most common issues. You can also get help from your fellow merchants in the [WooCommerce support forums](https://wordpress.org/support/plugin/woocommerce/).
  ...
  - [See all topics](https://woocommerce.com/documentation/woocommerce/get-help/)
