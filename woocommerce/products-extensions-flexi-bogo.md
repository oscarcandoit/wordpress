---
url: https://woocommerce.com/documentation/products/extensions/flexi-bogo
scraped_at: 2025-10-20T02:30:38.100Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/flexi-bogo/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/flexi-bogo/#page)
...
Discount Rule – Buy X Get X Discount Rule – Buy X Get Y

- [**Additional Settings**](https://woocommerce.com/document/additional-settings/)
Applying Discounts to Regular Prices With the Flexi BOGO for WooCommerce plugin, you can not only offer free products but also offer when purchasing a specific item, the other item will be at a reduced price. This plugin lets you choose whether discounts are calculated based on the Sale price or the Regular price of your products. Our \[…\]

- [**Discount Rule – Buy X Get X**](https://woocommerce.com/document/discount-rule-buy-x-get-x/)
Buy 1 Get 1, Buy 2 Get 2, and More 1. Filter (Buy) based on 2. Discount – Description – Buy 2 Get 1, Buy 4 Get 2, and More 1. Filter (Buy) based on 2. Discount – 3. Description: Buy 1 and Get Next Quantity of the Same Item at 10% Off 1. Filter \[…\]

- [**Discount Rule – Buy X Get Y**](https://woocommerce.com/document/discount-rule-buy-x-get-y/)
Buy 2 Quantity of Product X and Get 1 Product Y Free 1. Filter (Buy) based on 2. Discount 3. Description Buy Product X with Minimum Quantity 5 and Get 30% Off Product Y 1. Filter (Buy) based on 2. Discount 3. Description 2. If quantity of Beanie is less than 5 or greater than \[…\]

- [**Flexi BOGO FAQs**](https://woocommerce.com/document/flexi-bogo-faqs/)
Flexi BOGO offers a comprehensive solution for creating Buy One, Get One (BOGO) deals, enabling store owners to configure dynamic discount rules, special offers, and free product promotions, all within WooCommerce. With Flexi BOGO, you can set up tailored deals to boost sales, reward loyal customers, and attract new buyers. This article addresses some of \[…\]

- [**Flexi BOGO for WooCommerce**](https://woocommerce.com/document/flexi-bogo/)
Flexi BOGO for WooCommerce allows you to create customized “Buy One, Get One” (BOGO) offers tailored to your store’s needs. With this plugin, you can set up flexible discount rules where customers can get free or discounted products based on their purchases. You can define conditions such as the number of products bought, product categories, \[…\]

- [**Target Discounts based on User Roles and Specific Users**](https://woocommerce.com/document/target-discounts-based-on-user-roles-and-specific-users/)
This feature lets administrators set discount rules based on user roles or specific users. It ensures that discounts are applied accurately to meet the defined conditions. User Role This feature allows administrators to create more granular and targeted discount rules based on specific user roles. This ensures that discounts are only applied to users with \[…\]
