---
url: https://woocommerce.com/documentation/products/extensions/product-add-ons/product-add-ons-use-cases
scraped_at: 2025-10-20T02:41:40.106Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/product-add-ons/product-add-ons-use-cases/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/product-add-ons/product-add-ons-use-cases/#page)
...
- [**Use Case: Flower Shop**](https://woocommerce.com/document/use-case-flower-shop/)
Scenario You own a flower shop that makes handmade flower arrangements. You have put together several flower arrangements, but you would like your customers to have the choice of selecting several options for creating the arrangement. Products Used WooCommerceWooCommerce Product Addons Setup and Configuration Create Products We’ll first need to create all the flower arrangement \[…\]

- [**Use Case: Job Agency**](https://woocommerce.com/document/use-case-job-agency/)
Scenario You own a Job Agency and you would like your customers to be able to sign up as a member to access additional pages on your site. When signing up you want them to be able to upload a CV document. Products Used WooCommerce WooCommerce Memberships WooCommerce Product Addons Setup and Configuration Create membership \[…\]

- [**Use Case: Spa Service**](https://woocommerce.com/document/use-case-spa-service/)
Scenario You own a Spa Service and you would like to include a percentage based gratuity option for your customers, when they book a spa session. Products Used WooCommerce WooCommerce Bookings WooCommerce Product Addons Setup and Configuration Create Bookable product Go to: Product > Add Product In Product Data, select Bookable product Set the Booking \[…\]
