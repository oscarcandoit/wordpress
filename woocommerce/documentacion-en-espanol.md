---
url: https://woocommerce.com/documentation/documentacion-en-espanol
scraped_at: 2025-10-20T02:28:50.184Z
---

[Skip to navigation](https://woocommerce.com/documentation/documentacion-en-espanol/#main-navigation) [Skip to content](https://woocommerce.com/documentation/documentacion-en-espanol/#page)
...
- ## 1\. Instalación y Actualizaciones
  ...
  - [See all topics](https://woocommerce.com/documentation/documentacion-en-espanol/instalacion-y-actualizaciones/)
- ## 2\. Ajustes y Configuraciones
  ...
  - [See all topics](https://woocommerce.com/documentation/documentacion-en-espanol/ajustes-y-configuraciones/)
- ## 3\. Configurar Productos
  ...
  - [See all topics](https://woocommerce.com/documentation/documentacion-en-espanol/configurar-productos/)
- ## 4\. Vender Productos
  ...
  - [See all topics](https://woocommerce.com/documentation/documentacion-en-espanol/vender-productos/)
- ## 5\. Envíos
  ...
  - [See all topics](https://woocommerce.com/documentation/documentacion-en-espanol/envios/)
- ## 6\. Gestión de Pedidos



  - [Gestión de pedidos](https://woocommerce.com/document/gestion-de-pedidos/)
  - [Preguntas frecuentes sobre los correos electrónicos](https://woocommerce.com/document/preguntas-frecuentes-sobre-los-correos-electronicos/)
  - [Reembolsos de WooCommerce](https://woocommerce.com/document/reembolsos-de-woocommerce/)
  - [See all topics](https://woocommerce.com/documentation/documentacion-en-espanol/gestion-de-pedidos/)
- ## Bookings (Español)
  ...
  - [See all topics](https://woocommerce.com/documentation/documentacion-en-espanol/bookings-espanol/)
- ## 7\. Análisis y Reportes de Ventas
  ...
  - [See all topics](https://woocommerce.com/documentation/documentacion-en-espanol/analisis-y-reportes-de-ventas/)
- ## 8\. Migrar a WooCommerce



  - [Importar productos de Etsy](https://woocommerce.com/document/importar-productos-de-etsy/)
  - [See all topics](https://woocommerce.com/documentation/documentacion-en-espanol/migrar-a-woocommerce-documentacion-en-espanol/)

* * *

## Documents

- [**Guía de autoservicio de WooCommerce**](https://woocommerce.com/document/guia-de-autoservicio-de-woocommerce/)
La solución de problemas y las pruebas de conflictos de WooCommerce son útiles para descubrir por qué tu sitio tiene problemas. ¿Tienes algún problema con tu tienda WooCommerce? Nuestro objetivo es ayudarte a solucionarlo. Los tres problemas más comunes Según las estadísticas, la mayoría son causados por: Software obsoleto en tu sitio Conflicto con tu \[…\]

- [**Preguntas frecuentes**](https://woocommerce.com/document/preguntas-frecuentes/)
Esta página contiene respuestas a preguntas frecuentes relacionadas con WooCommerce, productos vendidos en WooCommerce.com y gestión de cuentas en WooCommerce.com. Preguntas generales ¿Qué es WordPress? WordPress es un sistema de gestión de contenido (CMS). Es un software que te ayuda a crear, gestionar y compartir tu contenido en la web. Actualmente, WordPress tiene dos versiones, \[…\]
