---
url: https://woocommerce.com/documentation/products/extensions/woocommerce-product-search/settings-woocommerce-product-search
scraped_at: 2025-10-20T02:37:17.789Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/woocommerce-product-search/settings-woocommerce-product-search/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/woocommerce-product-search/settings-woocommerce-product-search/#page)
...
- [**File Cache**](https://woocommerce.com/document/woocommerce-product-search/settings/cache/file-cache/)
...
- [**General Settings**](https://woocommerce.com/document/woocommerce-product-search/settings/general/)
...
- [**Memcached**](https://woocommerce.com/document/woocommerce-product-search/settings/cache/memcached/)
...
- [**Object Cache**](https://woocommerce.com/document/woocommerce-product-search/settings/cache/object-cache/)
...
- [**Redis**](https://woocommerce.com/document/woocommerce-product-search/settings/cache/redis/)
Settings The settings in this section apply to the Redis integration of the WooCommerce Product Search extension. When enabled, the system can use a Redis in-memory data structure store for high-performance caching. You will find these settings on your WordPress dashboard, go to WooCommerce > Settings > Search > Cache > Redis You can have \[…\]

- [**Search Index**](https://woocommerce.com/document/woocommerce-product-search/settings/index/)
...
- [**Search Weights**](https://woocommerce.com/document/woocommerce-product-search/settings/weights/)
