---
url: https://woocommerce.com/documentation/products/extensions/woocommerce-memberships/integrations
scraped_at: 2025-10-20T02:32:24.214Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/woocommerce-memberships/integrations/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/woocommerce-memberships/integrations/#page)
...
- [**WooCommerce Memberships bbPress Integration**](https://woocommerce.com/document/woocommerce-memberships-bbpress-integration/)
Overview WooCommerce Memberships currently has very basic compatibility with bbPress, and requires you to use certain content restriction modes in order to restrict forums, topics, and/or topic tags. If you’d like to see improved compatibility with bbPress, please vote for it here – feedback is always appreciated! Requirements To restrict bbPress forums, topics, and replies, \[…\]

- [**WooCommerce Memberships Brands Integration**](https://woocommerce.com/document/woocommerce-memberships-brands/)
If you use WooCommerce Brands to create additional categorization and filtering on your site, you can use WooCommerce Memberships to restrict Brands or offer brand discounts to members. Restricting brand products When you sell items from specific brands in your marketplace, you can restrict those items to members just as you can any other products. \[…\]

- [**WooCommerce Memberships Groups Integration**](https://woocommerce.com/document/woocommerce-memberships-groups-integration/)
If you use (or have used) the Groups plugin for WordPress to manage user groups and capabilities, you can import user’s groups as user Memberships. When groups are imported, you can map the user groups to a membership plan. For example, any member in the “Silver” group can be given access to the “Silver membership” \[…\]

- [**WooCommerce Memberships Product Vendors Integration**](https://woocommerce.com/document/woocommerce-memberships-product-vendors-integration/)
If you use WooCommerce Product Vendors to create a marketplace on your site, you can use WooCommerce Memberships to integrate with that marketplace to restrict access to vendor products. Restricting vendor products When you sell items from vendors in your marketplace, you can restrict those items to members just as you can any other products. \[…\]

- [**WooCommerce Memberships Sensei LMS Integration**](https://woocommerce.com/document/woocommerce-memberships-sensei-integration/)
Overview & requirements WooCommerce Memberships can be used with Sensei LMS to restrict course and lesson access for learners unless they have an active membership. Restrict courses When you set up your courses and want to control access via the membership, you’ll need to check your Sensei LMS settings, the course setup, and your membership \[…\]

- [**WooCommerce Memberships User Switching Integration**](https://woocommerce.com/document/woocommerce-memberships-user-switching-integration/)
Overview The User Switching plugin is a fantastic free plugin that allows you to swap to any user account on your site. When this plugin is active on your site while Memberships is activated, a User Switching integration will let you impersonate members to test out your restriction and discount rules. How it Works The \[…\]

- [**WooCommerce Memberships Subscriptions Integration**](https://woocommerce.com/document/woocommerce-memberships-subscriptions-integration/)
Overview While WooCommerce Memberships works very well on its own to help you sell set-length memberships, it’s very tightly integrated with Woo Subscriptions to let you sell recurring memberships, as well as take advantage of some additional features that Subscriptions provides. Subscriptions allows your customers to upgrade, downgrade, or pause their own subscriptions, which will \[…\]
