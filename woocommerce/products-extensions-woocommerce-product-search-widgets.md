---
url: https://woocommerce.com/documentation/products/extensions/woocommerce-product-search/widgets
scraped_at: 2025-10-20T02:42:09.067Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/woocommerce-product-search/widgets/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/woocommerce-product-search/widgets/#page)
...
The exclusive blocks provided with the extension make it easy to set up live search and filter features for customers in a matter of minutes. Template customizations and shop page compositions based on blocks are handled easily. In the following tutorial, we customize the Product Catalog template. The template uses the Product Collection block and \[…\]

- [**Product Filter – Attributes**](https://woocommerce.com/document/woocommerce-product-search/blocks/product-filter-attributes/)
The Product Filter – Attributes block is part of the WooCommerce Product Search extension and provides a live product attribute filter for your shop. While your customers choose the desired terms, it finds matching products and shows them on the shop page.   This live filter displays the terms of a product attribute. The customer \[…\]
...
- [**Product Filter – Categories**](https://woocommerce.com/document/woocommerce-product-search/blocks/product-filter-categories/)
The Product Filter – Categories block is part of the WooCommerce Product Search extension and provides a live product category filter for your shop. While your customers choose the desired category, it finds matching products and shows them on the shop page.   This live filter shows the product categories which the customer can click. \[…\]

- [**Product Filter – Categories**](https://woocommerce.com/document/woocommerce-product-search/widgets/product-filter-categories/)
Legacy Widget The Product Filter – Categories widget that is part of the WooCommerce Product Search extension provides a live product category filter for your shop. While your customers choose the desired category, it finds matching products and shows them on the shop page. This live filter shows the product categories which the customer can \[…\]

- [**Product Filter – Price**](https://woocommerce.com/document/woocommerce-product-search/blocks/product-filter-price/)
The Product Filter – Price block that is part of the WooCommerce Product Search provides a live price filter for your shop. While your customers indicate the minimum or maximum price in its fields, it finds matching products and shows them on the shop page.   This live filter renders two fields where the customer \[…\]

- [**Product Filter – Price**](https://woocommerce.com/document/woocommerce-product-search/widgets/product-filter-price/)
Legacy Widget The Product Filter – Price widget that is part of the WooCommerce Product Search extension provides a live price filter for your shop. While your customers indicate the minimum or maximum price in its fields, it finds matching products and shows them on the shop page. This live filter renders two fields where \[…\]

- [**Product Filter – Products**](https://woocommerce.com/document/woocommerce-product-search/blocks/product-filter-products/)
The Product Filter – Products block is provided with the WooCommerce Product Search extension and shows products similar to the normal shop page. The block works in combination with the Product Filter blocks that the extension also provides. When you compose a particular page with a combination of product filters, you will also want to \[…\]

- [**Product Filter – Rating**](https://woocommerce.com/document/woocommerce-product-search/blocks/product-filter-rating/)
With the WooCommerce Product Search extension’s rating filter, customers have a convenient way of finding products quickly based on their rating. The Product Filter – Rating block provides a live product filter, which allows to restrict the products that are displayed to those which have a chosen average rating or higher.   The filter displays \[…\]

- [**Product Filter – Rating**](https://woocommerce.com/document/woocommerce-product-search/widgets/product-filter-rating/)
Legacy Widget With the WooCommerce Product Search extension’s rating filter, customers have a convenient way of finding products quickly based on their rating. The Product Filter – Rating widget provides a live product filter, which allows to restrict the products that are displayed to those which have a chosen average rating or higher. The filter \[…\]
