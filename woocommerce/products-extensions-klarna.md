---
url: https://woocommerce.com/documentation/products/extensions/klarna
scraped_at: 2025-10-20T02:32:45.743Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/klarna/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/klarna/#page)
...
- ## Klarna Checkout
  ...
  - [Klarna Checkout – Extra checkout fields](https://woocommerce.com/document/klarna-checkout-extra-checkout-fields/)
  - [Klarna Checkout – introduction](https://woocommerce.com/document/klarna-checkout/)
  - [Klarna Checkout – recurring payments](https://woocommerce.com/document/klarna-checkout-recurring-payments/)
  - [See all topics](https://woocommerce.com/documentation/products/extensions/klarna/klarna-checkout/)
- ## Klarna Payments



  - [Klarna for WooCommerce](https://woocommerce.com/document/klarna-payments/)
  - [See all topics](https://woocommerce.com/documentation/products/extensions/klarna/klarna-payments/)
- ## Klarna Order Management



  - [Klarna – order management](https://woocommerce.com/document/klarna-order-management/)
  - [See all topics](https://woocommerce.com/documentation/products/extensions/klarna/klarna-order-management/)
...
- [**Klarna – order management**](https://woocommerce.com/document/klarna-order-management/)
When an order is created in WooCommerce and a order number exists in Klarna’s system, you have the option to handle the order management in Klarna directly from the WooCommerce shop admin. This keeps Woo shop and Klarna order data in synch, and saves time to avoid having to update both systems manually. Related documentation \[…\]

- [**Move to Klarna’s new and improved platform**](https://woocommerce.com/document/moving-v2-v3-klarna/)
Klarna Checkout for WooCommerce and Klarna Payments for WooCommerce have quite recently been released. These plugins replaces the old WooCommerce Klarna gateway. As a merchant it’s recommended that you switch from the old plugin to one of the two new plugins. To start the transition process you need to apply for it. Klick here to \[…\]
