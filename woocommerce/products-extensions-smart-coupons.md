---
url: https://woocommerce.com/documentation/products/extensions/smart-coupons
scraped_at: 2025-10-20T02:37:43.152Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/smart-coupons/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/smart-coupons/#page)
...
Smart Coupons provide a powerful, “all-in-one” solution for gift certificates, store credits, discount coupons, and vouchers. The below code snippets help you customize and tailor Smart Coupons according to your needs. You can try formatting the coupon code to generate only numerical values and avoid certain characters. You can also try small tweaks to the \[…\]
...
Smart Coupons provide a powerful, “all-in-one” solution for gift cards, store credits, discount coupons, and vouchers, extending the core functionality of WooCommerce coupons. This document explains how users can choose one gift product when there are multiple available on the cart and checkout pages. Steps to choose one gift product: That’s it!

- [**How to allow your customers to send gift coupons**](https://woocommerce.com/document/smart-coupons/how-to-allow-your-customers-to-send-gift-coupons/)
Smart Coupons provides a powerful, all-in-one solution for gift cards, store credits, discount coupons, and vouchers, extending the core functionality of WooCommerce coupons. This documentation explains how you can enable your customers to send gift coupons to someone else. This feature allows your customers to share discounts, store credits and gift vouchers with their friends \[…\]

- [**How to apply coupons on cheapest / costliest product in cart**](https://woocommerce.com/document/smart-coupons/how-to-apply-coupons-on-cheapest-costliest-product-in-cart/)
Smart Coupons provides a powerful, “all-in-one” solution for gift cards, store credits, discount coupons and vouchers extending the core functionality of WooCommerce coupons. This document describes how to use a coupon or store credit/voucher for a WooCommerce store’s cheapest or most expensive item in the cart. Smart Coupons helps you with a variety of features, \[…\]

- [**How to assign gift certificates to user**](https://woocommerce.com/document/smart-coupons/how-to-assign-gift-certificates-to-user/)
Smart Coupons provide a powerful, “all-in-one” solution for gift cards, store credits, discount coupons, and vouchers, extending the core functionality of WooCommerce coupons. This document provides a step-by-step guide on how to create a gift certificate manually for the customer within your WooCommerce store. Steps to assign a gift certificate to a user manually That’s \[…\]

- [**How to auto apply coupons**](https://woocommerce.com/document/smart-coupons/how-to-auto-apply-coupon/)
...
- [**How to auto apply tiered discounts based on customer’s spending**](https://woocommerce.com/document/smart-coupons/how-to-auto-apply-tiered-discounts-based-on-customers-spending/)
Smart Coupons provide a powerful, “all-in-one” solution for gift cards, store credits, discount coupons, and vouchers, extending the core functionality of WooCommerce coupons. This document provides a step-by-step guide on how to auto apply tiered discounts based on customer’s spending within your WooCommerce store. Steps to configure 1. Create three coupons To begin, you’ll need \[…\]

- [**How to auto-generate coupons (using shortcode)**](https://woocommerce.com/document/smart-coupons/how-to-auto-generate-coupons-using-shortcode/)
...
- [**How to autocomplete gift card order status**](https://woocommerce.com/document/smart-coupons/how-to-autocomplete-gift-card-order-status/)
