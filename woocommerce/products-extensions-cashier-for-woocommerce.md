---
url: https://woocommerce.com/documentation/products/extensions/cashier-for-woocommerce
scraped_at: 2025-10-20T02:27:54.620Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/cashier-for-woocommerce/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/cashier-for-woocommerce/#page)
...
Cashier for WooCommerce is a single plugin for all major customizations in cart / checkout flow within WooCommerce. Installation More information at: Installing and Managing Plugins. Enable plugin updates Please follow the steps listed here to enable plugin updates for Cashier. Setup and Configuration To find the settings in the WordPress Admin, go to WooCommerce > Settings \[…\]

- [**Checkout Field Editor**](https://woocommerce.com/document/cashier-for-woocommerce/checkout-field-editor/)
Cashier is an all-in-one WooCommerce checkout optimization plugin. You get checkout field editor, one-page checkout, direct checkout with Buy Now buttons and other enhancements. This doc explains how you can edit/remove the core WooCommerce checkout fields and also add custom fields for an optimized checkout. Configuring checkout fields Go to WooCommerce > Cashier. Click on \[…\]

- [**How do I enable guest checkout**](https://woocommerce.com/document/cashier-for-woocommerce/how-do-i-enable-guest-checkout/)
Cashier is an all-in-one WooCommerce checkout optimization plugin. You can set up one-page checkout, direct checkout with Buy Now buttons, checkout field editor and other enhancements. This doc explains how you can enable a guest checkout i.e allow guest users to skip cart and checkout directly using Buy Now buttons in WooCommerce. This is quite \[…\]

- [**How to Enable a Direct Checkout**](https://woocommerce.com/document/cashier-for-woocommerce/how-to-enable-a-direct-checkout/)
...
- [**How to Enable One Page Checkout**](https://woocommerce.com/document/cashier-for-woocommerce/how-to-enable-one-page-checkout/)
Cashier is an all-in-one WooCommerce checkout optimization plugin. You can set up one-page checkout, direct checkout with Buy Now buttons, checkout field editor and other enhancements. This doc explains how you can create special pages or turn any page into a one-page checkout page on your WooCommerce store. Customers can add or remove products, fill \[…\]

- [**How to enable one-click checkout**](https://woocommerce.com/document/cashier-for-woocommerce/how-to-enable-one-click-checkout/)
Cashier is an all-in-one WooCommerce checkout optimization plugin. You can set up one-page checkout, direct checkout with Buy Now buttons, checkout field editor and other enhancements. This doc explains how to enable one-click checkout in WooCommerce to allow users to quickly make a purchase and maximize sales. In this case, one-click checkout means direct order \[…\]

- [**How to enable Side Cart widget**](https://woocommerce.com/document/cashier-for-woocommerce/how-to-enable-side-cart-widget/)
...
- [**How to redirect to checkout or other pages on click of ‘Add to Cart’ link**](https://woocommerce.com/document/cashier-for-woocommerce/how-to-redirect-to-checkout-or-other-pages-on-click-of-add-to-cart-link/)
...
- [**How to set up Cost of Goods**](https://woocommerce.com/document/cashier-for-woocommerce/how-to-set-up-cost-of-goods/)
Cashier for WooCommerce plugin allows you to track your total profit and cost of goods sold by adding a Cost of Good field to simple and variable products. The costs per item and order are automatically calculated on checkout. Setup and Configuration You can add a cost to your products while editing them. This cost \[…\]

- [**How to set up product recommendations automatically**](https://woocommerce.com/document/cashier-for-woocommerce/how-to-set-up-product-recommendations-automatically/)
