---
url: https://woocommerce.com/documentation/products/extensions/product-feed-manager
scraped_at: 2025-10-20T02:36:07.925Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/product-feed-manager/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/product-feed-manager/#page)
...
Welcome to the Woo Product Feed Manager documentation! Here, you can find all the essential information to help you create, manage, and optimize your product feeds for multiple marketing channels. Whether you’re looking to expand your reach or improve your product visibility, this guide will walk you through everything you need. Explore the sections below \[…\]

- [**Install and Activate**](https://woocommerce.com/document/product-feed-manager/install-and-activate/)
The Product Feed Manager extension can be installed in the same way as any other extension from WooCommerce.com. More information at: Installing and Managing Plugins. Once you’ve installed the plugin you can start setting up your first product feed.

- [**Set Up Your Feed**](https://woocommerce.com/document/product-feed-manager/set-up-your-feed/)
Setting up your product feed in the Woo Product Feed Manager is a straightforward process. Follow the steps below to install a channel, configure your feed, and optimize your product listings for better performance across multiple platforms. 1. Installing a Channel in the Channel Manager For each sales channel, we have a so-called template that \[…\]

- [**Generate Your Feed**](https://woocommerce.com/document/product-feed-manager/generate-your-feed/)
Once you have set up your product feed and mapped the attributes, click the “Save Feed” button. At this point, the feed is not yet generated, but it is safely stored in the database to prevent any loss of your configurations. Before generating the feed, review the feed settings and category mappings carefully. Consider the following questions: \[…\]

- [**Submit to Marketing Channels**](https://woocommerce.com/document/product-feed-manager/submit-to-marketing-channels/)
The Woo Product Feed Manager generates product feed files that you need to manually submit to your preferred channels. Woo Product Feed Manager does not provide direct API connections to marketing platforms. Instead, you will need to submit the feed file URL to the merchant center of each channel manually. This should be done only \[…\]

- [**Plugin settings**](https://woocommerce.com/document/product-feed-manager/plugin-settings/)
Using the “Settings” link in the Product Feed Manager menu or the “Settings” link on the top Right of the plugin header. Clicking on it will navigate you to our plugin’s settings page, where you’ll discover an array of plugin settings. These settings will assist you in utilizing the plugin effectively and generating optimal product \[…\]
