---
url: https://woocommerce.com/documentation/products/extensions/back-in-stock-notifications
scraped_at: 2025-10-20T02:25:56.612Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/back-in-stock-notifications/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/back-in-stock-notifications/#page)
...
- [**Frequently Asked Questions**](https://woocommerce.com/document/back-in-stock-notifications/faq/)
Notification e-mails are not delivered to signed-up customers. Here’s how to diagnose issues with undelivered e-mails: 1. Check if WooCommerce is able to process and send notifications. The plugin sends notification e-mails in batches using Action Scheduler — a robust task queuing system used by WooCommerce to process scheduled updates and other tasks in the \[…\]

- [**Store Owner’s Guide**](https://woocommerce.com/document/back-in-stock-notifications/store-owners-guide/)
Installation More information at: Install and Activate Plugins/Extensions. Requirements Since version 2.0.0, the extension requires: Getting Started Back In Stock Notifications helps you recapture lost revenue by notifying customers when your sold-out products are restocked. Back-in-stock alerts are a proven way to re-engage customers: Some studies suggest that up to 20% of the customers who \[…\]
