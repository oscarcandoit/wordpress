---
url: https://woocommerce.com/documentation/products/themes
scraped_at: 2025-10-20T02:40:53.581Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/themes/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/themes/#page)
...
- ## Storefront
  ...
  - [Extension Integrations](https://woocommerce.com/document/extension-integrations/)
  - [Installing Storefront in your language](https://woocommerce.com/document/installing-storefront-in-your-language/)
  - [Remove ‘Designed by WooThemes’ from footer](https://woocommerce.com/document/remove-designed-by-woothemes-from-footer/)
  - [See all topics](https://woocommerce.com/documentation/products/themes/storefront/)
- ## Retired Themes
  ...
  - [See all topics](https://woocommerce.com/documentation/products/themes/retired-themes/)
...
Installation & Demo Content Import Thank you for choosing AnySell theme to build your WooCommerce website. To create a site with AnySell, you must install the AnySell theme and WooCommerce plugin. Installation Required Plugins Import Demo Site After installation and activation of the theme and required plugins. You can now install the demo content to \[…\]

- [**Apparel**](https://woocommerce.com/document/apparel/)
Welcome to the Apparel WooCommerce Theme documentation. This comprehensive guide will walk you through the process of setting up and customizing your Apparel theme to create a stunning and fully functional online store. The Apparel theme is a chic, versatile, and feature-rich solution designed to elevate your fashion and lifestyle store with its sophisticated aesthetics \[…\]

- [**Artistry**](https://woocommerce.com/document/artistry/)
Installation To install the Artistry theme you must first have a working WordPress installation. For information on installing WordPress, please see Installing WordPress, from the WordPress Codex. You can install your theme following these instructions: WordPress Dashboard: Please Note: If you use Safari as your primary browser you may find that your theme folder is \[…\]

- [**Aspicio**](https://woocommerce.com/document/aspicio/)
As an e-commerce owner, you have a lot to think about: from production costs and assessing the quality consistency of your products to providing a unique shopping experience to customers and managing customer support. It’s needless to say you have a lot on your plate. To help you save time and take at least one \[…\]

- [**Auto-X**](https://woocommerce.com/document/auto-x/)
Welcome to the Auto-X Theme Documentation! Thank you for choosing Auto-X for your WooCommerce store. This guide will walk you through the installation and customization process, helping you launch a fast, professional, and fully responsive online shop with ease. Install and Activate WooCommerce Since Auto-X is designed specifically for WooCommerce, you need to install and \[…\]

- [**Avalon Fashion Block Theme**](https://woocommerce.com/document/avalon/)
Theme Installation and Setup You can find more here. How to start working with the theme? Important: to be able to effectively use this theme, with all its features, it is required to have the latest WordPress version installed and the default block editor enabled. There are two ways to start building your site with this \[…\]

- [**Bagaicha**](https://woocommerce.com/document/bagaicha/)
Thank you for choosing Bagaicha for your new project. This documentation will provide you with step-by-step instructions on installing and configuring the theme. To navigate the various sections, please utilize the menu located on the right-hand side of the screen. Introducing Bagaicha Theme Effortlessly create a stunning online pant store with Bagaicha! This meticulously designed \[…\]

- [**Bagberry Theme Documentation**](https://woocommerce.com/document/bagberry-theme-documentation/)
...
- [**Basti Theme**](https://woocommerce.com/document/basti-theme/)
Theme Installation and Setup You can find more here. How to start working with the theme? Important: to be able to effectively use this theme, with all its features, it is required to have the latest WordPress version installed and the default block editor enabled. There are two ways to start building your site with this \[…\]

- [**Beleco**](https://woocommerce.com/document/beleco-theme/)
Beleco is a breathtaking WordPress theme that will help you sell beauty and skincare products. Thanks to the theme’s stunning design, your website visitors will keep browsing and adding multiple products to their carts. Theme installation Theme can be installed two ways – through the WordPress admin dashboard or by uploading files through FTP manually. \[…\]
