---
url: https://woocommerce.com/documentation/documentacao-em-portugues/vender-produtos
scraped_at: 2025-10-20T02:23:52.690Z
---

[Skip to navigation](https://woocommerce.com/documentation/documentacao-em-portugues/vender-produtos/#main-navigation) [Skip to content](https://woocommerce.com/documentation/documentacao-em-portugues/vender-produtos/#page)
...
- ## Opções de Pagamento Básicas



  - [PayPal Standard (Português)](https://woocommerce.com/document/paypal-standard-portugues/)
  - [See all topics](https://woocommerce.com/documentation/documentacao-em-portugues/vender-produtos/opcoes-de-pagamento-basicas/)
- ## Método de Pagamento



  - [PayPal Checkout (Português)](https://woocommerce.com/document/paypal-checkout-portugues/)
  - [See all topics](https://woocommerce.com/documentation/documentacao-em-portugues/vender-produtos/metodo-de-pagamento/)
...
As leis de VAT (IVA – Imposto sobre Valor Agregado) da UE para produtos digitais mudaram em 1º de janeiro de 2015, afetando apenas as transações B2C. O VAT sobre produtos digitais deve ser calculado com base na localização do cliente e é necessário que você colete evidências sobre isso usando um endereço IP e/ou \[…\]

- [**Gerenciamento de Cupons**](https://woocommerce.com/document/gerenciamento-de-cupons/)
Cupons são uma ótima maneira de oferecer descontos e recompensas aos seus clientes e podem ajudar a promover as vendas em sua loja. Para usar os cupons com o WooCommerce. Vá para: WooCommerce > Configurações > Geral > Ativar cupons Selecione a caixa de seleção para Ativar o uso de código de cupons. Salve as \[…\]

- [**Pagamento na Entrega**](https://woocommerce.com/document/pagamento-na-entrega/)
Pagamento na entrega (Cash on Delivery ou COD) é um método de pagamento no qual não é necessário que o pagamento seja efetuado online. Os pedidos que são realizados usando Pagamento na entrega são definidos com status Processando até que o pagamento seja efetuado na entrega do pedido, por você ou pelo seu método de \[…\]

- [**Pagamentos Com Cheques**](https://woocommerce.com/document/pagamentos-com-cheques/)
O Pagamento com cheques é um método de pagamento no qual não é necessário que o pagamento seja efetuado online. Os pedidos que são realizados usando Pagamentos com cheque são definidos com status Aguardando até que o pagamento seja efetuado fora do WooCommerce. Você, como proprietário da loja, deve confirmar se os pagamentos dos cheques \[…\]

- [**Qual é a opção de pagamento ideal para mim?**](https://woocommerce.com/document/qual-e-a-opcao-de-pagamento-ideal-para-mim/)
Existem dezenas de opções de método de pagamento (disponível somente em inglês) para o WooCommerce. O que é um método de pagamento? Um método de pagamento, nos termos do WooCommerce, é um plugin do WordPress para o WooCommerce no qual permite que os clientes possam pagar por produtos e serviços, usando um sistema de pagamento \[…\]

- [**Transferência Bancária Direta**](https://woocommerce.com/document/transferencia-bancaria-direta/)
A Transferência bancária direta é um método de pagamento no qual não é necessário que o pagamento seja efetuado online. Os pedidos que são realizados usando Transferência bancária direta são definidos com status Aguardando até que o pagamento seja efetuado fora do WooCommerce. Você, como proprietário da loja, deve confirmar se os pagamentos foram compensados \[…\]
