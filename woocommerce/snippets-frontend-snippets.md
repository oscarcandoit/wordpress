---
url: https://woocommerce.com/documentation/snippets/frontend-snippets
scraped_at: 2025-10-20T02:31:23.307Z
---

[Skip to navigation](https://woocommerce.com/documentation/snippets/frontend-snippets/#main-navigation) [Skip to content](https://woocommerce.com/documentation/snippets/frontend-snippets/#page)
...
- [**Apply a coupon for minimum cart total**](https://woocommerce.com/document/apply-a-coupon-for-minimum-cart-total/)
...
- [**Change Limit on Number of Variations for Dynamic Variable Product Dropdowns**](https://woocommerce.com/document/change-limit-on-number-of-variations-for-dynamic-variable-product-dropdowns/)
...
- [**Change the default state and country on the checkout**](https://woocommerce.com/document/change-the-default-state-and-country-on-the-checkout/)
Add code to your child theme’s functions.php file or via a plugin that allows custom functions to be added, such as the Code snippets plugin. Avoid adding custom code directly to your parent theme’s functions.php file as this will be wiped entirely when you update the theme. This file contains hidden or bidirectional Unicode text \[…\]

- [**Check if address field contains house number (using WooCommerce Blocks)**](https://woocommerce.com/document/check-if-address-field-contains-house-number-using-woocommerce-blocks/)
...
- [**Custom sorting options (asc/desc)**](https://woocommerce.com/document/custom-sorting-options-ascdesc/)
A snippet to add new sorting options to the catalog.

- [**Custom tracking code for the thanks page**](https://woocommerce.com/document/custom-tracking-code-for-the-thanks-page/)
...
- [**Customize the WooCommerce breadcrumb**](https://woocommerce.com/document/customise-the-woocommerce-breadcrumb/)
