---
url: https://woocommerce.com/documentation/products/extensions/woocommerce-product-search
scraped_at: 2025-10-20T02:42:37.477Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/woocommerce-product-search/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/woocommerce-product-search/#page)
...
The **[WooCommerce Product Search](https://woocommerce.com/products/woocommerce-product-search/)** extension provides an advanced Search Engine and Search Experience for you and your customers.
...
- ## Setup
  ...
  - [Setup](https://woocommerce.com/document/woocommerce-product-search/setup/)
  - [See all topics](https://woocommerce.com/documentation/products/extensions/woocommerce-product-search/setup/)
- ## Settings



  - [Assistant](https://woocommerce.com/document/woocommerce-product-search/settings/assistant/)
  - [Cache](https://woocommerce.com/document/woocommerce-product-search/settings/cache/)
  - [CSS](https://woocommerce.com/document/woocommerce-product-search/settings/css/)
  - [See all topics](https://woocommerce.com/documentation/products/extensions/woocommerce-product-search/settings-woocommerce-product-search/)
- ## Reports



  - [Queries](https://woocommerce.com/document/woocommerce-product-search/reports/queries/)
  - [Reports](https://woocommerce.com/document/woocommerce-product-search/reports/)
  - [Role Based Analytics for WooCommerce](https://woocommerce.com/document/role-based-analytics-for-woocommerce/)
  - [See all topics](https://woocommerce.com/documentation/products/extensions/woocommerce-product-search/reports/)
- ## Widgets



  - [Blocks](https://woocommerce.com/document/woocommerce-product-search/blocks/)
  - [Product Filter – Attributes](https://woocommerce.com/document/woocommerce-product-search/blocks/product-filter-attributes/)
  - [Product Filter – Attributes](https://woocommerce.com/document/woocommerce-product-search/widgets/product-filter-attributes/)
  - [See all topics](https://woocommerce.com/documentation/products/extensions/woocommerce-product-search/widgets/)
- ## Shortcodes



  - [\[woocommerce\_product\_filter\_attribute\]](https://woocommerce.com/document/woocommerce-product-search/shortcodes/woocommerce_product_filter_attribute/)
  - [\[woocommerce\_product\_filter\_brand\]](https://woocommerce.com/document/woocommerce-product-search/shortcodes/woocommerce_product_filter_brand/)
  - [\[woocommerce\_product\_filter\_category\]](https://woocommerce.com/document/woocommerce-product-search/shortcodes/woocommerce_product_filter_category/)
  - [See all topics](https://woocommerce.com/documentation/products/extensions/woocommerce-product-search/shortcodes/)
- ## Developer Documentation



  - [Actions](https://woocommerce.com/document/woocommerce-product-search/api/actions/)
  - [ANZ eGate](https://woocommerce.com/document/anz-egate/)
  - [API](https://woocommerce.com/document/woocommerce-product-search/api/)
  - [See all topics](https://woocommerce.com/documentation/products/extensions/woocommerce-product-search/developer-documentation-woocommerce-product-search/)
...
The shortcode \[woocommerce\_product\_filter\_reset\] provides a button to reset all currently active live product filters. This is displayed when any active filters can be cleared and hidden when there are no active filters. Use this shortcode along with the extension’s live product filters as a convenient facility to have all filters cleared in one go. This \[…\]
...
- [**Functions**](https://woocommerce.com/document/woocommerce-product-search/api/functions/)
All of the following functions take an optional array as their function argument, holding options equivalent to those that the Shortcodes allow. Please refer to documentation of the corresponding shortcode for details on the accepted attributes. All functions return a string which can be used to render the corresponding HTML in a PHP template. woocommerce\_product\_search() \[…\]

- [**Product Filter – Attributes**](https://woocommerce.com/document/woocommerce-product-search/widgets/product-filter-attributes/)
Legacy Widget The Product Filter – Attributes widget that is part of the WooCommerce Product Search extension provides a live product attribute filter for your shop. While your customers choose the desired terms, it finds matching products and shows them on the shop page. This live filter displays the terms of a product attribute. The \[…\]

- [**Product Filter – Brands**](https://woocommerce.com/document/woocommerce-product-search/blocks/product-filter-brands/)
The Product Filter – Brands block is part of the WooCommerce Product Search extension and provides a live product brand filter for your shop. While your customers choose the desired brand, it finds matching products and shows them on the shop page. To use this block, you must have at least WooCommerce 9.4 with the \[…\]

- [**Product Filter – Reset**](https://woocommerce.com/document/woocommerce-product-search/widgets/product-filter-reset/)
Legacy Widget The Product Filter – Reset widget provides a means of resetting all currently active live product filters. This way, the visitor can simply click a button to clear all filters at once. Settings The Title field allows to set the title of the widget. It’s useful to leave this empty and use the \[…\]

- [**Product Filter – Sale**](https://woocommerce.com/document/woocommerce-product-search/widgets/product-filter-sale/)
Legacy Widget The WooCommerce Product Search extension features a great way for customers to find products which are on sale. Its Product Filter – Sale widget provides a live product filter, which allows to restrict the products that are displayed to those which are on sale.

- [**Product Search Field**](https://woocommerce.com/document/woocommerce-product-search/blocks/product-search-field/)
The WooCommerce Product Search extension features the Product Search Field block that provides instant search results as you type in its search field. Use this block anywhere on your site to allow customers to find and buy a product. With an online shop, it makes sense to offer this search facility prominently and on any page \[…\]

- [**Products**](https://woocommerce.com/document/woocommerce-product-search/api/rest/products/)
