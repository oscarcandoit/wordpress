---
url: https://woocommerce.com/documentation/products
scraped_at: 2025-10-20T02:36:37.690Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/#page)
...
- Documentation
  ...
  - [Documentação em Português](https://woocommerce.com/documentation/documentacao-em-portugues/ "Documentação em Português") Expand    - [1\. Como Instalar e Atualizar](https://woocommerce.com/documentation/documentacao-em-portugues/como-instalar-e-atualizar/ "1. Como Instalar e Atualizar")
    ...
    - [5\. Entrega](https://woocommerce.com/documentation/documentacao-em-portugues/5-entrega/ "5. Entrega") Expand      - [Opções de Entrega Básicas](https://woocommerce.com/documentation/documentacao-em-portugues/5-entrega/opcoes-de-entrega-basicas/ "Opções de Entrega Básicas")
...
Explore documentation related to Extensions, Themes, and more.
...
Here you'll find documentation for all of the Extensions that are sold in the Woo Marketplace, including Woo-owned extensions.
  ...
  - [See all topics](https://woocommerce.com/documentation/products/extensions/)
- ## Themes


This category contains documentation for Themes sold in the woo Marketplace.
  - [AnySell](https://woocommerce.com/document/anysell/)
  - [Apparel](https://woocommerce.com/document/apparel/)
  - [Artistry](https://woocommerce.com/document/artistry/)
  - [See all topics](https://woocommerce.com/documentation/products/themes/)
- ## WooPayments


Educational resources for [WooPayments](https://woocommerce.com/payments/) – the only payment method designed exclusively for WooCommerce, by WooCommerce.

Start here: [WooPayments Documentation](https://woocommerce.com/document/woopayments/)
  - [Apple Pay and Google Pay compatibility](https://woocommerce.com/document/woopayments/payment-methods/apple-pay-and-google-pay-compatibility/)
  - [Buy now, pay later with WooPayments](https://woocommerce.com/document/woopayments/payment-methods/buy-now-pay-later/)
  - [Can I customize the appearance of the payment form fields?](https://woocommerce.com/document/woopayments/customization-and-translation/customize-payments-appearance/)
  - [See all topics](https://woocommerce.com/documentation/products/woopayments/)
- ## WooPay


Documentation for WooPay, a new express checkout solution for WooCommerce stores.
  - [WooPay Customer Documentation](https://woocommerce.com/document/woopay-customer-documentation/)
  - [WooPay Merchant Documentation](https://woocommerce.com/document/woopay-merchant-documentation/)
  - [See all topics](https://woocommerce.com/documentation/products/woopay/)
- ## WooCommerce Shipping



  - [WooCommerce Shipping](https://woocommerce.com/document/woocommerce-shipping/)
  - [WooCommerce Shipping Adjustment Fees](https://woocommerce.com/document/shipping-adjustment-fees/)
  - [See all topics](https://woocommerce.com/documentation/products/woocommerce-shipping/)

* * *

## Documents

- [**Advanced Extra Fees for WooCommerce**](https://woocommerce.com/document/advanced-extra-fees/)
The Advanced Extra Fee for WooCommerce plugin enables WooCommerce store owners to add extra fees based on various conditions. It is an essential tool for businesses looking to increase revenue without modifying base product prices by adding dynamic fees at checkout.  This document provides insights into the plugin’s requirements, installation, functionality, and usage to help \[…\]

- [**Affiliate Program For WooCommerce**](https://woocommerce.com/document/affiliate-program-for-woocommerce/)
The Affiliate Program for WooCommerce plugin is a robust and flexible solution for managing affiliate marketing within your WooCommerce store. It enables you to grow your business by rewarding users who refer new customers to your store. Key Features of the WooCommerce Affiliate Program: Benefits of Integrating Affiliate Program for WooCommerce: Requirements To install Affiliate \[…\]

- [**How to clear Smart Coupons cache in WooCommerce**](https://woocommerce.com/document/how-to-clear-smart-coupons-cache-in-woocommerce/)
Smart Coupons provide a powerful, “all-in-one” solution for gift cards, store credits, discount coupons, and vouchers, extending the core functionality of WooCommerce coupons. This doc explains how to clear the Smart Coupons cache in the WooCommerce store. Smart Coupons cache helps your store load eligible coupons faster by temporarily storing results instead of repeatedly checking \[…\]

- [**How to restrict a coupon by number of orders made**](https://woocommerce.com/document/how-to-restrict-a-coupon-by-number-of-orders-made/)
Smart Coupons provide a powerful, “all-in-one” solution for gift cards, store credits, discount coupons, and vouchers extending the core functionality of WooCommerce coupons. The number of orders made restriction can limit coupon usage based on how many completed orders a customer has placed. This helps you offer an exclusive discount to your frequent buyers and \[…\]

- [**How to Setup BOGO for WooCommerce**](https://woocommerce.com/document/pricepulse-dynamic-discounts-and-coupons/how-to-setup-bogo-for-woocommerce/)
🛠️ Creating a Bogo Discount Rule – Step-by-Step Walkthrough This example demonstrates how to set up a Buy One Get One (BOGO) rule using PricePulse. 🎯 Goal Create a BOGO offer: Buy 1 T-shirt, Get 1 Free. Step 1: Navigate to PricePulse Go to WooCommerce → PricePulse from your WordPress dashboard. 🖼️ Screenshot Example:WooCommerce > PricePulse Step 2: Add a \[…\]

- [**How to show Store Credit balance anywhere**](https://woocommerce.com/document/how-to-show-store-credit-balance-anywhere/)
Smart Coupons provide a powerful, “all-in-one” solution for gift cards, store credits, discount coupons, and vouchers extending the core functionality of WooCommerce coupons. This doc explains how to display the Store Credit balance anywhere on your WooCommerce store using shortcode. By default the Store Credit balance is available on the My Account page. Now if \[…\]

- [**How to upload an image for gift cards**](https://woocommerce.com/document/how-to-upload-an-image-for-gift-cards/)
Smart Coupons provide a powerful, “all-in-one” solution for gift cards, store credits, discount coupons, and vouchers, extending the core functionality of WooCommerce coupons. This doc article explains how to allow customers to upload an image to send with the gift card. Smart Coupons lets you enhance your gift cards by allowing customers to upload an \[…\]

- [**Use Case: Letting Customers Pick a Free Gift with Smart Coupons During the Holiday Season**](https://woocommerce.com/document/use-case-letting-customers-pick-a-free-gift-with-smart-coupons-during-the-holiday-season/)
Overview During the holiday season, customers love surprises and thoughtful gifts. With Smart Coupons for WooCommerce, you can give them the option to pick one free product from a set of items you decide. This is achieved by creating a coupon with a fixed cart discount and using the Add products to cart option in \[…\]

- [**Use Case: Offering a Free Product on the Next Order When a User Spends a Minimum Amount**](https://woocommerce.com/document/use-case-offering-a-free-product-on-the-next-order-when-a-user-spends-a-minimum-amount/)
Overview Rewarding loyal customers with free products is a great way to boost repeat purchases. With Smart Coupons for WooCommerce, you can set up a promotion where customers unlock a free product on their next order once they spend a minimum amount. This strategy not only drives higher order values but also encourages customers to \[…\]
