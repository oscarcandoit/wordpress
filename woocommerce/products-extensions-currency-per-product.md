---
url: https://woocommerce.com/documentation/products/extensions/currency-per-product
scraped_at: 2025-10-20T02:28:28.585Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/currency-per-product/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/currency-per-product/#page)
...
Behaviour Settings Currency per Product for WooCommerce Pro plugin allows you to set and  display product prices in different currencies. There are various scenarios in which you can display the product prices in different currencies on Shop page, Cart and Checkout page: The behaviours of Shop, Cart, and Checkout pages can be set using the Behaviour options of this plugin. It also includes options for letting users manually switch currencies via the Currency Switcher \[…\]

- [**Currency Per Product for WooCommerce**](https://woocommerce.com/document/currency-per-product/)
Currency per Product for WooCommerce Pro plugin allows you to set and display products in different currencies. You can setup exchange rates manually or automatically for the same and also take payments in store currency. This plugin works with all WooCommerce product types. General Settings Currency per Product for WooCommerce How this works? After installing the plugin, a new tab – Currency per \[…\]
