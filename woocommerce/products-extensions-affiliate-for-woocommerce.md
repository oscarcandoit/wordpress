---
url: https://woocommerce.com/documentation/products/extensions/affiliate-for-woocommerce
scraped_at: 2025-10-20T02:25:35.057Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/affiliate-for-woocommerce/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/affiliate-for-woocommerce/#page)
...
Learn how to set up, manage, and grow your Affiliate for WooCommerce program with guides, tutorials, and tips to optimize affiliates and payouts.

- [**Affiliate for WooCommerce FAQs**](https://woocommerce.com/document/affiliate-for-woocommerce/faqs/)
1\. Where can an affiliate login? WooCommerce creates a My Account page for logged-in users/affiliates which gives an overview of their past orders, edit addresses, and payment details. You can read more about it here. So an affiliate can log in to their account from WooCommerce’s My Account page. If you are using a custom \[…\]

- [**Affiliate for WooCommerce Onboarding Guide**](https://woocommerce.com/document/affiliate-for-woocommerce/onboarding/)
Affiliate for WooCommerce helps add and manage affiliates and track performance from a single place – commissions, sales, payout, leaderboard, etc. Earn money without hard work. Increase your brand outreach, and get potential customers. The plugin simplifies your onboarding by guiding you through the initial setup. This ensures your affiliate program is ready to go \[…\]

- [**Affiliate For WooCommerce Settings**](https://woocommerce.com/document/affiliate-for-woocommerce/settings/)
Affiliate for WooCommerce plugin helps you to add, manage affiliates, and track performance from a single place – commissions, sales, payouts, leaderboard, etc. Earn money without hard work. Increase your brand outreach, and get potential customers. This doc explains the various plugin settings. You’ll find them under WordPress admin > WooCommerce > Settings > Affiliate. \[…\]

- [**Affiliate Program Terms and Conditions**](https://woocommerce.com/document/affiliate-for-woocommerce/affiliate-program-terms-and-conditions/)
Affiliate for WooCommerce helps add and manage affiliates and track performance from a single place – commissions, sales, payout, leaderboard, etc. Earn money without hard work. Increase your brand outreach, and get potential customers. You can test the plugin on our live demo. Running an affiliate program can be a game-changer for your store, helping you \[…\]

- [**How affiliates can use shareable referral coupon links to drive sales**](https://woocommerce.com/document/affiliate-for-woocommerce/how-affiliates-can-use-shareable-referral-coupon-links-to-drive-sales/)
This doc explains how affiliates can use shareable referral coupon links to drive sales

- [**How does Affiliate for WooCommerce plugin work with caching**](https://woocommerce.com/document/affiliate-for-woocommerce/how-does-affiliate-for-woocommerce-plugin-work-with-caching/)
Affiliate for WooCommerce plugin helps you to add, manage affiliates, and track performance from a single place – commissions, sales, payouts, leaderboard, etc. Earn money without hard work. Increase your brand outreach, and get potential customers. It’s common for store owners to use caching solutions to boost website loading times. The Affiliate for WooCommerce plugin \[…\]

- [**How to access the affiliate dashboard (Affiliate Area) and customize it**](https://woocommerce.com/document/affiliate-for-woocommerce/how-to-access-affiliate-dashboard/)
Learn how to setup affiliate’s dashboard (affiliate area) and customie it

- [**How to assign / unassign an order to an affiliate**](https://woocommerce.com/document/affiliate-for-woocommerce/how-to-assign-unassign-an-order-to-an-affiliate/)
Affiliate for WooCommerce plugin helps you to add, manage affiliates, and track performance from a single place – commissions, sales, payouts, leaderboard, etc. Earn money without hard work. Increase your brand outreach, and get potential customers. It may happen that when your affiliates promote your product, someone lands on your website through it but without \[…\]

- [**How to assign a custom user role to an affiliate**](https://woocommerce.com/document/affiliate-for-woocommerce/how-to-assign-a-custom-user-role-to-an-affiliate/)
Affiliate for WooCommerce plugin helps you to add, manage affiliates, and track performance from a single place – commissions, sales, payouts, leaderboard, etc. Earn money without hard work. Increase your brand outreach, and get potential customers. Tips to use the below code on your site You can securely add code snippets to your site using \[…\]
