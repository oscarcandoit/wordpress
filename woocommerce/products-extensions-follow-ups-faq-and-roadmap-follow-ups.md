---
url: https://woocommerce.com/documentation/products/extensions/follow-ups/faq-and-roadmap-follow-ups
scraped_at: 2025-10-20T02:30:28.701Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/follow-ups/faq-and-roadmap-follow-ups/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/follow-ups/faq-and-roadmap-follow-ups/#page)
...
Twelve steps to WooCommerce Follow-up Email happiness. 1. Product Matches Exact product matches are processed first, followed by always\_send product matches. Look for specific product matches that are always\_send=off and email\_type!=storewide Skip date emails that have send dates in the past Store remaining matches sorted by priority as $emails 2. “Always Send” Product Matches always\_send \[…\]
...
WooCommerce Follow-ups is a premium extension. Emails aren’t getting sent! Why? If CRON is foreign to you, first make sure this line DOES NOT exist in your wp-config file: define(‘DISABLE\_WP\_CRON’, true); If it does, remove it immediately and spend some time re-testing the plugin on your system. There are several other factors that could prevent emails \[…\]
