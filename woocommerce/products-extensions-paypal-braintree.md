---
url: https://woocommerce.com/documentation/products/extensions/paypal-braintree
scraped_at: 2025-10-20T02:35:33.792Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/paypal-braintree/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/paypal-braintree/#page)
...
Actions The \[gateway\_id\] placeholders below can be ‘braintree\_credit\_card’ or ‘braintree\_paypal’ wc\_\[gateway\_id\]\_before\_product\_button\_add\_to\_cart Triggered directly before the add to cart button (where PayPal “Buy Now” buttons are added). do\_action( ‘wc\_\[gateway\_id\]\_before\_product\_button\_add\_to\_cart’, $product\_id, $quantity, $variation\_id, $cart\_data ); wc\_payment\_gateway\_\[gateway\_id\]\_payment\_processed Fires when a payment is processed for an order. /\*\* \* Payment Gateway Payment Processed Action. \* \* Fires when a \[…\]
