---
url: https://woocommerce.com/documentation/products/extensions/woocommerce-sales-analysis
scraped_at: 2025-10-20T02:42:41.552Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/woocommerce-sales-analysis/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/woocommerce-sales-analysis/#page)
...
Role-Based Analytics for WooCommerce adds powerful reporting tools to your store’s Analytics dashboard. With a dedicated User Roles report, performance cards, time and role comparison charts, and a detailed leaderboard, you can track sales, orders, gross and net revenue, and returns by user role. Features include single and multi-role filtering, CSV export, customizable columns, and native WooCommerce date controls—giving you clear, actionable insights into how each role drives your business.

- [**Sales Analysis for WooCommerce**](https://woocommerce.com/document/sales-analysis-for-woocommerce/)
Sales Analysis helps the management of a business to evaluate its economic performance, to recognize trends and to make appropriate decisions. With accurate real-time data readily present, the reporting tools we put at the manager’s disposal are essential to discover trends and to optimize the profit margin of your business. These analyses also help your \[…\]

- [**Overview**](https://woocommerce.com/document/sales-analysis-for-woocommerce/overview/)
The extension’s reports are available in the Sales Analysis menu. From there, you can conveniently reach all reports that the extension provides: The reports reflect data based on the following: Each report presents its data for a given time period. Standard time periods include the last 7 days, the current month, last month and the \[…\]

- [**API**](https://woocommerce.com/document/sales-analysis-for-woocommerce/api/)
Filters The extension provides the following filters which can be used to include order statuses in its calculations in addition to those that it uses by default. The reports all are based on orders that are either processing or completed. If you would like to include custom order statuses, you can use these filters to \[…\]

- [**Customer Analysis**](https://woocommerce.com/document/sales-analysis-for-woocommerce/customer-analysis/)
This Customer Analysis concentrates on the number of customers and related revenue by country. The report provides answers to these key questions: The Customer Analysis that is provided in this report provides a detailed view on the number of customers per country, related revenue and orders. This analysis can help management in refining the marketing \[…\]

- [**Order Analysis**](https://woocommerce.com/document/sales-analysis-for-woocommerce/order-analysis/)
...
- [**Product Revenue**](https://woocommerce.com/document/sales-analysis-for-woocommerce/product-revenue/)
The report on Product Revenue represents the total net revenue per product for any desired period of time. This report provides specific insights: The data provided by the Product Revenue report is useful to study the profitability and profit margins of products sold. When it is looked at along with the reports on Unit Sales \[…\]

- [**Products by Country**](https://woocommerce.com/document/sales-analysis-for-woocommerce/products-by-country/)
The report on Products by Country provides a detailed view on the orders placed per product and country. This report is very valuable in that it provides answers to these questions, among others: The report is one in a set of product-centric reports which provide data on a per-product basis for the following aspects: Product, \[…\]

- [**Revenue Analysis**](https://woocommerce.com/document/sales-analysis-for-woocommerce/revenue-analysis/)
...
- [**Unit Sales**](https://woocommerce.com/document/sales-analysis-for-woocommerce/unit-sales/)
Unit Sales represent the total number of individual items sold per product, within a given period of time. The report on Unit Sales answers questions like: The evolution of Unit Sales over time can help to determine whether the business is experiencing growth or decline in specific product lines and overall. Unit Sales are also \[…\]
