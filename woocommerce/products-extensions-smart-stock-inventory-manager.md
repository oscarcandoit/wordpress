---
url: https://woocommerce.com/documentation/products/extensions/smart-stock-inventory-manager
scraped_at: 2025-10-20T02:37:47.517Z
---

[Skip to navigation](https://woocommerce.com/documentation/products/extensions/smart-stock-inventory-manager/#main-navigation) [Skip to content](https://woocommerce.com/documentation/products/extensions/smart-stock-inventory-manager/#page)
...
Manage product stock and variations from a single screen. Easy, smooth and convenient inventory management plugin. Installation More information at: Installing and Managing Plugins. Enable plugin updates Please follow the steps listed here to enable plugin updates for Smart Stock & Inventory Manager. Setup and Configuration This plugin works out of the box with no \[…\]

- [**Smart Stock & Inventory Manager For WooCommerce FAQs**](https://woocommerce.com/document/smart-stock-inventory-manager/faqs/)
1\. Can we manage/edit any custom fields? No. 2. Can we manage custom product types, such as WooCommerce Subscriptions? Yes, you can manage WooCommerce Subscriptions and update their data using the Smart Stock & Inventory Manager. You can edit product fields like SKU, Price, Stock, Title, and more. Additionally, you can view Stock History by \[…\]
