...
scraped_at: 2025-10-20T02:28:51.654Z
---

[Skip to main content](https://getbootstrap.com/docs/5.3/customize/color-modes/#content) [Skip to docs navigation](https://getbootstrap.com/docs/5.3/customize/color-modes/#bd-docs-nav)
...
## Dark mode [Link to this section: Dark mode](https://getbootstrap.com/docs/5.3/customize/color-modes/\#dark-mode)
...
Alternatively, you can also switch to a media query implementation thanks to our color mode mixin—see [the usage section for details](https://getbootstrap.com/docs/5.3/customize/color-modes/#building-with-sass). Heads up though—this eliminates your ability to change themes on a per-component basis as shown below.

## Example [Link to this section: Example](https://getbootstrap.com/docs/5.3/customize/color-modes/\#example)
...
- [Action](https://getbootstrap.com/docs/5.3/customize/color-modes/#)
- [Action](https://getbootstrap.com/docs/5.3/customize/color-modes/#)
- [Another action](https://getbootstrap.com/docs/5.3/customize/color-modes/#)
- [Something else here](https://getbootstrap.com/docs/5.3/customize/color-modes/#)
- * * *

- [Separated link](https://getbootstrap.com/docs/5.3/customize/color-modes/#)
...
## How it works [Link to this section: How it works](https://getbootstrap.com/docs/5.3/customize/color-modes/\#how-it-works)
...
## Usage [Link to this section: Usage](https://getbootstrap.com/docs/5.3/customize/color-modes/\#usage)

### Enable dark mode [Link to this section: Enable dark mode](https://getbootstrap.com/docs/5.3/customize/color-modes/\#enable-dark-mode)
...
Bootstrap does not yet ship with a built-in color mode picker, but you can use the one from our own documentation if you like. [Learn more in the JavaScript section.](https://getbootstrap.com/docs/5.3/customize/color-modes/#javascript)

### Building with Sass [Link to this section: Building with Sass](https://getbootstrap.com/docs/5.3/customize/color-modes/\#building-with-sass)
...
## Custom color modes [Link to this section: Custom color modes](https://getbootstrap.com/docs/5.3/customize/color-modes/\#custom-color-modes)
...
## JavaScript [Link to this section: JavaScript](https://getbootstrap.com/docs/5.3/customize/color-modes/\#javascript)
...
## Adding theme colors [Link to this section: Adding theme colors](https://getbootstrap.com/docs/5.3/customize/color-modes/\#adding-theme-colors)
...
## CSS [Link to this section: CSS](https://getbootstrap.com/docs/5.3/customize/color-modes/\#css)

### Variables [Link to this section: Variables](https://getbootstrap.com/docs/5.3/customize/color-modes/\#variables)

Dozens of root level CSS variables are repeated as overrides for dark mode. These are scoped to the color mode selector, which defaults to `data-bs-theme` but [can be configured](https://getbootstrap.com/docs/5.3/customize/color-modes/#building-with-sass) to use a `prefers-color-scheme` media query. Use these variables as a guideline for generating your own new color modes.
...
### Sass variables [Link to this section: Sass variables](https://getbootstrap.com/docs/5.3/customize/color-modes/\#sass-variables)
...
### Sass mixins [Link to this section: Sass mixins](https://getbootstrap.com/docs/5.3/customize/color-modes/\#sass-mixins)

Styles for dark mode, and any custom color modes you create, can be scoped appropriately to the `data-bs-theme` attribute selector or media query with the customizable `color-mode()` mixin. See the [Sass usage section](https://getbootstrap.com/docs/5.3/customize/color-modes/#building-with-sass) for more details.
