---
url: https://getbootstrap.com/docs/4.4/components/scrollspy
scraped_at: 2025-10-20T02:38:57.458Z
---

[Skip to main content](https://getbootstrap.com/docs/4.4/components/scrollspy/#content)
...
## How it works [Anchor](https://getbootstrap.com/docs/4.4/components/scrollspy/\#how-it-works)
...
- It must be used on a Bootstrap [nav component](https://getbootstrap.com/docs/4.4/components/navs/) or [list group](https://getbootstrap.com/docs/4.4/components/list-group/).
...
## Example in navbar [Anchor](https://getbootstrap.com/docs/4.4/components/scrollspy/\#example-in-navbar)
...
## Example with nested nav [Anchor](https://getbootstrap.com/docs/4.4/components/scrollspy/\#example-with-nested-nav)
...
## Example with list-group [Anchor](https://getbootstrap.com/docs/4.4/components/scrollspy/\#example-with-list-group)

Scrollspy also works with `.list-group` s. Scroll the area next to the list group and watch the active class change.

[Item 1](https://getbootstrap.com/docs/4.4/components/scrollspy/#list-item-1) [Item 2](https://getbootstrap.com/docs/4.4/components/scrollspy/#list-item-2) [Item 3](https://getbootstrap.com/docs/4.4/components/scrollspy/#list-item-3) [Item 4](https://getbootstrap.com/docs/4.4/components/scrollspy/#list-item-4)
...
## Usage [Anchor](https://getbootstrap.com/docs/4.4/components/scrollspy/\#usage)

### Via data attributes [Anchor](https://getbootstrap.com/docs/4.4/components/scrollspy/\#via-data-attributes)
...
### Via JavaScript [Anchor](https://getbootstrap.com/docs/4.4/components/scrollspy/\#via-javascript)
...
### Methods [Anchor](https://getbootstrap.com/docs/4.4/components/scrollspy/\#methods)

#### `.scrollspy('refresh')` [Anchor](https://getbootstrap.com/docs/4.4/components/scrollspy/\#scrollspyrefresh)
...
#### `.scrollspy('dispose')` [Anchor](https://getbootstrap.com/docs/4.4/components/scrollspy/\#scrollspydispose)

Destroys an element’s scrollspy.

### Options [Anchor](https://getbootstrap.com/docs/4.4/components/scrollspy/\#options)
...
### Events [Anchor](https://getbootstrap.com/docs/4.4/components/scrollspy/\#events)
