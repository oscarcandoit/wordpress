...
scraped_at: 2025-10-20T02:39:17.034Z
---

[Skip to main content](https://getbootstrap.com/docs/5.0/utilities/api/#content) [Skip to docs navigation](https://getbootstrap.com/docs/5.0/utilities/api/#bd-docs-nav)

[There's a newer version of Bootstrap!](https://getbootstrap.com/)

[View on GitHub](https://github.com/twbs/bootstrap/blob/v5.0.2/site/content/docs/5.0/utilities/api.md "View and edit this file on GitHub")
...
## API explained [Anchor](https://getbootstrap.com/docs/5.0/utilities/api/\#api-explained)
...
### Custom class prefix [Anchor](https://getbootstrap.com/docs/5.0/utilities/api/\#custom-class-prefix)
...
### States [Anchor](https://getbootstrap.com/docs/5.0/utilities/api/\#states)
...
### Responsive utilities [Anchor](https://getbootstrap.com/docs/5.0/utilities/api/\#responsive-utilities)

Add the `responsive` boolean to generate responsive utilities (e.g., `.opacity-md-25`) across [all breakpoints](https://getbootstrap.com/docs/5.0/layout/breakpoints/).
...
### Changing utilities [Anchor](https://getbootstrap.com/docs/5.0/utilities/api/\#changing-utilities)
...
### Print utilities [Anchor](https://getbootstrap.com/docs/5.0/utilities/api/\#print-utilities)
...
## Importance [Anchor](https://getbootstrap.com/docs/5.0/utilities/api/\#importance)
...
## Using the API [Anchor](https://getbootstrap.com/docs/5.0/utilities/api/\#using-the-api)

Now that you’re familiar with how the utilities API works, learn how to add your own custom classes and modify our default utilities.

### Add utilities [Anchor](https://getbootstrap.com/docs/5.0/utilities/api/\#add-utilities)
...
### Modify utilities [Anchor](https://getbootstrap.com/docs/5.0/utilities/api/\#modify-utilities)
...
#### Enable responsive [Anchor](https://getbootstrap.com/docs/5.0/utilities/api/\#enable-responsive)
...
#### Rename utilities [Anchor](https://getbootstrap.com/docs/5.0/utilities/api/\#rename-utilities)
...
### Remove utilities [Anchor](https://getbootstrap.com/docs/5.0/utilities/api/\#remove-utilities)
...
#### Remove utility in RTL [Anchor](https://getbootstrap.com/docs/5.0/utilities/api/\#remove-utility-in-rtl)
