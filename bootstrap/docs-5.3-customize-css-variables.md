...
scraped_at: 2025-10-20T02:29:00.691Z
---

[Skip to main content](https://getbootstrap.com/docs/5.3/customize/css-variables/#content) [Skip to docs navigation](https://getbootstrap.com/docs/5.3/customize/css-variables/#bd-docs-nav)
...
## Root variables [Link to this section: Root variables](https://getbootstrap.com/docs/5.3/customize/css-variables/\#root-variables)

Here are the variables we include (note that the `:root` is required) that can be accessed anywhere Bootstrap’s CSS is loaded. They’re located in our `_root.scss` file and included in our compiled dist files.

### Default [Link to this section: Default](https://getbootstrap.com/docs/5.3/customize/css-variables/\#default)
...
### Dark mode [Link to this section: Dark mode](https://getbootstrap.com/docs/5.3/customize/css-variables/\#dark-mode)
...
## Component variables [Link to this section: Component variables](https://getbootstrap.com/docs/5.3/customize/css-variables/\#component-variables)
...
## Prefix [Link to this section: Prefix](https://getbootstrap.com/docs/5.3/customize/css-variables/\#prefix)
...
## Examples [Link to this section: Examples](https://getbootstrap.com/docs/5.3/customize/css-variables/\#examples)
...
## Focus variables [Link to this section: Focus variables](https://getbootstrap.com/docs/5.3/customize/css-variables/\#focus-variables)
...
## Grid breakpoints [Link to this section: Grid breakpoints](https://getbootstrap.com/docs/5.3/customize/css-variables/\#grid-breakpoints)
