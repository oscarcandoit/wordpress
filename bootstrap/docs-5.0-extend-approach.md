---
url: https://getbootstrap.com/docs/5.0/extend/approach
scraped_at: 2025-10-20T02:41:07.444Z
---

[Skip to main content](https://getbootstrap.com/docs/5.0/extend/approach/#content) [Skip to docs navigation](https://getbootstrap.com/docs/5.0/extend/approach/#bd-docs-nav)

[There's a newer version of Bootstrap!](https://getbootstrap.com/)

[View on GitHub](https://github.com/twbs/bootstrap/blob/v5.0.2/site/content/docs/5.0/extend/approach.md "View and edit this file on GitHub")
...
## Summary [Anchor](https://getbootstrap.com/docs/5.0/extend/approach/\#summary)
...
## Responsive [Anchor](https://getbootstrap.com/docs/5.0/extend/approach/\#responsive)
...
## Classes [Anchor](https://getbootstrap.com/docs/5.0/extend/approach/\#classes)
...
## z-index scales [Anchor](https://getbootstrap.com/docs/5.0/extend/approach/\#z-index-scales)

There are two `z-index` scales in Bootstrap—elements within a component and overlay components.

### Component elements [Anchor](https://getbootstrap.com/docs/5.0/extend/approach/\#component-elements)
...
### Overlay components [Anchor](https://getbootstrap.com/docs/5.0/extend/approach/\#overlay-components)
...
Learn more about this in our [`z-index` layout page](https://getbootstrap.com/docs/5.0/layout/z-index/).

## HTML and CSS over JS [Anchor](https://getbootstrap.com/docs/5.0/extend/approach/\#html-and-css-over-js)

Whenever possible, we prefer to write HTML and CSS over JavaScript. In general, HTML and CSS are more prolific and accessible to more people of all different experience levels. HTML and CSS are also faster in your browser than JavaScript, and your browser generally provides a great deal of functionality for you.

This principle is our first-class JavaScript API using `data` attributes. You don’t need to write nearly any JavaScript to use our JavaScript plugins; instead, write HTML. Read more about this in [our JavaScript overview page](https://getbootstrap.com/docs/5.0/getting-started/javascript/#data-attributes).
...
## Utilities [Anchor](https://getbootstrap.com/docs/5.0/extend/approach/\#utilities)
...
## Flexible HTML [Anchor](https://getbootstrap.com/docs/5.0/extend/approach/\#flexible-html)

While not always possible, we strive to avoid being overly dogmatic in our HTML requirements for components. Thus, we focus on single classes in our CSS selectors and try to avoid immediate children selectors ( `>`). This gives you more flexibility in your implementation and helps keep our CSS simpler and less specific.

## Code conventions [Anchor](https://getbootstrap.com/docs/5.0/extend/approach/\#code-conventions)
