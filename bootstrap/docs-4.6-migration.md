---
url: https://getbootstrap.com/docs/4.6/migration
scraped_at: 2025-10-20T02:37:34.157Z
---

[Skip to main content](https://getbootstrap.com/docs/4.6/migration/#content) [Skip to docs navigation](https://getbootstrap.com/docs/4.6/migration/#bd-docs-nav)
...
[View on GitHub](https://github.com/twbs/bootstrap/blob/v4.6.2/site/content/docs/4.6/migration.md "View and edit this file on GitHub")
...
## Stable changes [Anchor](https://getbootstrap.com/docs/4.6/migration/\#stable-changes)

Moving from Beta 3 to our stable v4.x release, there are no breaking changes, but there are some notable changes.

### Printing [Anchor](https://getbootstrap.com/docs/4.6/migration/\#printing)
...
## Beta 3 changes [Anchor](https://getbootstrap.com/docs/4.6/migration/\#beta-3-changes)
...
### Miscellaneous [Anchor](https://getbootstrap.com/docs/4.6/migration/\#miscellaneous)
...
### Forms [Anchor](https://getbootstrap.com/docs/4.6/migration/\#forms)
...
### Input groups [Anchor](https://getbootstrap.com/docs/4.6/migration/\#input-groups)
...
## Beta 2 changes [Anchor](https://getbootstrap.com/docs/4.6/migration/\#beta-2-changes)
...
### Breaking [Anchor](https://getbootstrap.com/docs/4.6/migration/\#breaking)
...
### Highlights [Anchor](https://getbootstrap.com/docs/4.6/migration/\#highlights)
...
## Summary [Anchor](https://getbootstrap.com/docs/4.6/migration/\#summary)

Here are the big ticket items you’ll want to be aware of when moving from v3 to v4.

### Browser support [Anchor](https://getbootstrap.com/docs/4.6/migration/\#browser-support)
...
### Global changes [Anchor](https://getbootstrap.com/docs/4.6/migration/\#global-changes)
...
- Added dozens of new [utility classes](https://getbootstrap.com/docs/4.6/utilities/) for common CSS property-value pairs and margin/padding spacing shortcuts.

### Grid system [Anchor](https://getbootstrap.com/docs/4.6/migration/\#grid-system)
...
### Components [Anchor](https://getbootstrap.com/docs/4.6/migration/\#components)

- **Dropped panels, thumbnails, and wells** for a new all-encompassing component, [cards](https://getbootstrap.com/docs/4.6/components/card/).
- **Dropped the Glyphicons icon font.** If you need icons, some options are:

  - the upstream version of [Glyphicons](https://www.glyphicons.com/)
  - [Octicons](https://octicons.github.com/)
  - [Font Awesome](https://fontawesome.com/)
  - See the [Extend page](https://getbootstrap.com/docs/4.6/extend/icons/) for a list of alternatives. Have additional suggestions? Please open an issue or PR.
...
## By component [Anchor](https://getbootstrap.com/docs/4.6/migration/\#by-component)

This list highlights key changes by component between v3.x.x and v4.0.0.

### Reboot [Anchor](https://getbootstrap.com/docs/4.6/migration/\#reboot)

New to Bootstrap 4 is the [Reboot](https://getbootstrap.com/docs/4.6/content/reboot/), a new stylesheet that builds on Normalize with our own somewhat opinionated reset styles. Selectors appearing in this file only use elements—there are no classes here. This isolates our reset styles from our component styles for a more modular approach. Some of the most important resets this includes are the `box-sizing: border-box` change, moving from `em` to `rem` units on many elements, link styles, and many form element resets.

### Typography [Anchor](https://getbootstrap.com/docs/4.6/migration/\#typography)
...
### Images [Anchor](https://getbootstrap.com/docs/4.6/migration/\#images)

- Renamed `.img-responsive` to `.img-fluid`.
- Renamed `.img-rounded` to `.rounded`
- Renamed `.img-circle` to `.rounded-circle`

### Tables [Anchor](https://getbootstrap.com/docs/4.6/migration/\#tables)
...
### Forms [Anchor](https://getbootstrap.com/docs/4.6/migration/\#forms-1)
...
### Buttons [Anchor](https://getbootstrap.com/docs/4.6/migration/\#buttons)
...
### Button group [Anchor](https://getbootstrap.com/docs/4.6/migration/\#button-group)
...
### Dropdowns [Anchor](https://getbootstrap.com/docs/4.6/migration/\#dropdowns)
...
### Grid system [Anchor](https://getbootstrap.com/docs/4.6/migration/\#grid-system-1)
...
### List groups [Anchor](https://getbootstrap.com/docs/4.6/migration/\#list-groups)
...
### Navs [Anchor](https://getbootstrap.com/docs/4.6/migration/\#navs)
...
### Navbar [Anchor](https://getbootstrap.com/docs/4.6/migration/\#navbar)
...
- Navbars now require a background declaration of some kind. Choose from our background utilities ( `.bg-*`) or set your own with the light/inverse classes above [for mad customization](https://getbootstrap.com/docs/4.6/components/navbar/#color-schemes).
...
### Pagination [Anchor](https://getbootstrap.com/docs/4.6/migration/\#pagination)
...
### Labels and badges [Anchor](https://getbootstrap.com/docs/4.6/migration/\#labels-and-badges)
...
### Panels, thumbnails, and wells [Anchor](https://getbootstrap.com/docs/4.6/migration/\#panels-thumbnails-and-wells)

Dropped entirely for the new card component.

### Panels [Anchor](https://getbootstrap.com/docs/4.6/migration/\#panels)

- `.panel` to `.card`, now built with flexbox.
- `.panel-default` removed and no replacement.
- `.panel-group` removed and no replacement. `.card-group` is not a replacement, it is different.
- `.panel-heading` to `.card-header`
- `.panel-title` to `.card-title`. Depending on the desired look, you may also want to use [heading elements or classes](https://getbootstrap.com/docs/4.6/content/typography/#headings) (e.g. `<h3>`, `.h3`) or bold elements or classes (e.g. `<strong>`, `<b>`, [`.font-weight-bold`](https://getbootstrap.com/docs/4.6/utilities/text/#font-weight-and-italics)). Note that `.card-title`, while similarly named, produces a different look than `.panel-title`.
...
### Progress [Anchor](https://getbootstrap.com/docs/4.6/migration/\#progress)
...
### Carousel [Anchor](https://getbootstrap.com/docs/4.6/migration/\#carousel)
...
### Tables [Anchor](https://getbootstrap.com/docs/4.6/migration/\#tables-1)
...
### Utilities [Anchor](https://getbootstrap.com/docs/4.6/migration/\#utilities)

- **Display, hidden, and more:**
  - Made display utilities responsive (e.g., `.d-none` and `d-{sm,md,lg,xl}-none`).
  - Dropped the bulk of `.hidden-*` utilities for new [display utilities](https://getbootstrap.com/docs/4.6/utilities/display/). For example, instead of `.hidden-sm-up`, use `.d-sm-none`. Renamed the `.hidden-print` utilities to use the display utility naming scheme. More info under the [Responsive utilities](https://getbootstrap.com/docs/4.6/migration/#responsive-utilities) section of this page.
...
- **Alignment and spacing:**
  - Added new [responsive margin and padding utilities](https://getbootstrap.com/docs/4.6/utilities/spacing/) for all sides, plus vertical and horizontal shorthands.
  - Added boatload of [flexbox utilities](https://getbootstrap.com/docs/4.6/utilities/flex/).
  - Dropped `.center-block` for the new `.mx-auto` class.
- Clearfix updated to drop support for older browser versions.

### Vendor prefix mixins [Anchor](https://getbootstrap.com/docs/4.6/migration/\#vendor-prefix-mixins)
...
## Documentation [Anchor](https://getbootstrap.com/docs/4.6/migration/\#documentation)

Our documentation received an upgrade across the board as well. Here’s the low down:

- We’re still using Jekyll, but we have plugins in the mix:
  - `bugify.rb` is used to efficiently list out the entries on our [browser bugs](https://getbootstrap.com/docs/4.6/browser-bugs/) page.
...
### Responsive utilities [Anchor](https://getbootstrap.com/docs/4.6/migration/\#responsive-utilities)
